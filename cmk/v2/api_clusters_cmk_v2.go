...
// Filter the results where spec.deletion_protection is true or false.
func (r ApiListCmkV2ClustersRequest) SpecDeletionProtection(specDeletionProtection bool) ApiListCmkV2ClustersRequest {
	r.specDeletionProtection = &specDeletionProtection
	return r
}
...
func (a *ClustersCmkV2ApiService) ListCmkV2ClustersExecute(r ApiListCmkV2ClustersRequest) (CmkV2ClusterList, *_nethttp.Response, error) {
	...
	if r.specDeletionProtection != nil {
		localVarQueryParams.Add("spec.deletion_protection", parameterToString(*r.specDeletionProtection, ""))
	}
	localVarQueryParams.Add("environment", parameterToString(*r.environment, ""))
