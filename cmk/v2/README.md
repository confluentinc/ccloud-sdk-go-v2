...
The Cluster Management for Apache Kafka API provides comprehensive management
capabilities for Apache Kafka clusters on Confluent Cloud.
This API allows you to create, configure, monitor, and manage Kafka clusters
with different configurations including Basic, Standard, Dedicated, Enterprise,
and Freight cluster types.
