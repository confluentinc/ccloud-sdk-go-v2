...
The Cluster Management for Apache Kafka API provides comprehensive management capabilities for Apache Kafka clusters on Confluent Cloud. This API allows you to create, configure, monitor, and manage Kafka clusters with different configurations including Basic, Standard, Dedicated, Enterprise, and Freight cluster types.
...
type CmkV2ClusterSpec struct {
	...
	// The bootstrap endpoint used by Kafka clients to connect to the cluster.  DEPRECATED - Please use the `endpoints` attribute instead.
	// Deprecated
	KafkaBootstrapEndpoint *string `json:"kafka_bootstrap_endpoint,omitempty"`
	// The cluster HTTP request URL.  DEPRECATED - Please use the `endpoints` attribute instead.
	// Deprecated
	HttpEndpoint *string `json:"http_endpoint,omitempty"`
	// The Kafka API cluster endpoint used by Kafka clients to connect to the cluster.  DEPRECATED - Please use the `endpoints` attribute instead.
	// Deprecated
	ApiEndpoint *string `json:"api_endpoint,omitempty"`
	// A map of endpoints for connecting to the Kafka cluster, keyed by access_point_id. Access Point ID 'PUBLIC' and 'PRIVATE_LINK' are reserved. These can be used for different network access methods or regions.
	...
	// Note: For Pre-BYOK v1 clusters, API responses might show both `encryption_key` and `byok`. To manage Pre-BYOK v1 keys, refer to: https://docs.confluent.io/cloud/current/security/encrypt/byok/legacy-byok.html #manage-pre-byok-api-v1-self-managed-encryption-keys
...
func (o *CmkV2ClusterSpec) Redact() {
	...
	o.recurseRedact(o.DeletionProtection)
...
func (o CmkV2ClusterSpec) MarshalJSON() ([]byte, error) {
	...
	if o.DeletionProtection != nil {
		toSerialize["deletion_protection"] = o.DeletionProtection
	}
