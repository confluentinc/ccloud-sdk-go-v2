...
func NewCmkV2Dedicated(kind string, cku int32) *CmkV2Dedicated {
	...
	this.Kind = kind
	this.Cku = cku
	var releasePriority string = "REGULAR"
...
// GetReleasePriority returns the ReleasePriority field value if set, zero value otherwise.
func (o *CmkV2Dedicated) GetReleasePriority() string {
	if o == nil || o.ReleasePriority == nil {
		var ret string
		return ret
	}
	return *o.ReleasePriority
}

// GetReleasePriorityOk returns a tuple with the ReleasePriority field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CmkV2Dedicated) GetReleasePriorityOk() (*string, bool) {
	if o == nil || o.ReleasePriority == nil {
		return nil, false
	}
	return o.ReleasePriority, true
}
...
// SetReleasePriority gets a reference to the given string and assigns it to the ReleasePriority field.
...
func (o *CmkV2Dedicated) Redact() {
	...
	o.recurseRedact(o.ReleasePriority)
}
...
func (o CmkV2Dedicated) MarshalJSON() ([]byte, error) {
	...
	if o.ReleasePriority != nil {
		toSerialize["release_priority"] = o.ReleasePriority
	}
	buffer := &bytes.Buffer{}
