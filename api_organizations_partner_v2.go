...
// OrganizationsPartnerV2ApiService OrganizationsPartnerV2Api service
type OrganizationsPartnerV2ApiService service

type apiGetPartnerV2OrganizationRequest struct {
	ctx _context.Context
	apiService *OrganizationsPartnerV2ApiService
	id string
}
...
@return apiGetPartnerV2OrganizationRequest
*/
func (a *OrganizationsPartnerV2ApiService) GetPartnerV2Organization(ctx _context.Context, id string) apiGetPartnerV2OrganizationRequest {
	return apiGetPartnerV2OrganizationRequest{
		apiService: a,
		ctx: ctx,
		id: id,
...
Execute executes the request
 @return PartnerV2Organization
*/
func (r apiGetPartnerV2OrganizationRequest) Execute() (PartnerV2Organization, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  PartnerV2Organization
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsPartnerV2ApiService.GetPartnerV2Organization")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v2/organizations/{id}"
...
type apiListPartnerV2OrganizationsRequest struct {
	ctx _context.Context
	apiService *OrganizationsPartnerV2ApiService
	pageSize *int32
	pageToken *string
...
func (r apiListPartnerV2OrganizationsRequest) PageSize(pageSize int32) apiListPartnerV2OrganizationsRequest {
	r.pageSize = &pageSize
	return r
}

func (r apiListPartnerV2OrganizationsRequest) PageToken(pageToken string) apiListPartnerV2OrganizationsRequest {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return apiListPartnerV2OrganizationsRequest
*/
func (a *OrganizationsPartnerV2ApiService) ListPartnerV2Organizations(ctx _context.Context) apiListPartnerV2OrganizationsRequest {
	return apiListPartnerV2OrganizationsRequest{
		apiService: a,
		ctx: ctx,
	}
...
/*
Execute executes the request
 @return PartnerV2OrganizationList
*/
func (r apiListPartnerV2OrganizationsRequest) Execute() (PartnerV2OrganizationList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PartnerV2OrganizationList
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsPartnerV2ApiService.ListPartnerV2Organizations")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v2/organizations"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v PartnerV2OrganizationList
			err = r.apiService.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
