...
type WorkspacesWsV1beta1Api interface {
	...
	*/
	...
	// CreateWsV1beta1WorkspaceExecute executes the request
	...
	*/
	...
	// DeleteWsV1beta1WorkspaceExecute executes the request
	...
	*/
	...
	// GetWsV1beta1WorkspaceExecute executes the request
	//  @return WsV1beta1Workspace
	...
	*/
	...
	// ListWsV1beta1WorkspacesExecute executes the request
	...
	*/
	...
	// PutWsV1beta1WorkspaceExecute executes the request
	//  @return WsV1beta1Workspace
	PutWsV1beta1WorkspaceExecute(r ApiPutWsV1beta1WorkspaceRequest) (WsV1beta1Workspace, *_nethttp.Response, error)
}

// WorkspacesWsV1beta1ApiService WorkspacesWsV1beta1Api service
type WorkspacesWsV1beta1ApiService service

type ApiCreateWsV1beta1WorkspaceRequest struct {
	ctx                _context.Context
	ApiService         WorkspacesWsV1beta1Api
	organizationId     string
	environmentId      string
	wsV1beta1Workspace *WsV1beta1Workspace
}

func (r ApiCreateWsV1beta1WorkspaceRequest) WsV1beta1Workspace(wsV1beta1Workspace WsV1beta1Workspace) ApiCreateWsV1beta1WorkspaceRequest {
	r.wsV1beta1Workspace = &wsV1beta1Workspace
	return r
}

func (r ApiCreateWsV1beta1WorkspaceRequest) Execute() (WsV1beta1Workspace, *_nethttp.Response, error) {
	return r.ApiService.CreateWsV1beta1WorkspaceExecute(r)
}
...
func (a *WorkspacesWsV1beta1ApiService) CreateWsV1beta1WorkspaceExecute(r ApiCreateWsV1beta1WorkspaceRequest) (WsV1beta1Workspace, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesWsV1beta1ApiService.CreateWsV1beta1Workspace")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ws/v1beta1/organizations/{organization_id}/environments/{environment_id}/workspaces"
	...
	// body params
	localVarPostBody = r.wsV1beta1Workspace
...
type ApiDeleteWsV1beta1WorkspaceRequest struct {
	ctx            _context.Context
	ApiService     WorkspacesWsV1beta1Api
	organizationId string
	environmentId  string
...
func (r ApiDeleteWsV1beta1WorkspaceRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.DeleteWsV1beta1WorkspaceExecute(r)
}
...
// Execute executes the request
func (a *WorkspacesWsV1beta1ApiService) DeleteWsV1beta1WorkspaceExecute(r ApiDeleteWsV1beta1WorkspaceRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesWsV1beta1ApiService.DeleteWsV1beta1Workspace")
	if err != nil {
...
type ApiGetWsV1beta1WorkspaceRequest struct {
	ctx            _context.Context
	ApiService     WorkspacesWsV1beta1Api
	organizationId string
	environmentId  string
...
func (r ApiGetWsV1beta1WorkspaceRequest) Execute() (WsV1beta1Workspace, *_nethttp.Response, error) {
	return r.ApiService.GetWsV1beta1WorkspaceExecute(r)
}
...
func (a *WorkspacesWsV1beta1ApiService) GetWsV1beta1WorkspaceExecute(r ApiGetWsV1beta1WorkspaceRequest) (WsV1beta1Workspace, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesWsV1beta1ApiService.GetWsV1beta1Workspace")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type ApiListWsV1beta1WorkspacesRequest struct {
	ctx             _context.Context
	ApiService      WorkspacesWsV1beta1Api
	organizationId  string
	environmentId   string
...
func (r ApiListWsV1beta1WorkspacesRequest) SpecComputePool(specComputePool string) ApiListWsV1beta1WorkspacesRequest {
	r.specComputePool = &specComputePool
	return r
}

// A pagination size for collection requests.
func (r ApiListWsV1beta1WorkspacesRequest) PageSize(pageSize int32) ApiListWsV1beta1WorkspacesRequest {
	r.pageSize = &pageSize
	return r
}

// An opaque pagination token for collection requests.
func (r ApiListWsV1beta1WorkspacesRequest) PageToken(pageToken string) ApiListWsV1beta1WorkspacesRequest {
	r.pageToken = &pageToken
	return r
}

func (r ApiListWsV1beta1WorkspacesRequest) Execute() (WsV1beta1WorkspaceList, *_nethttp.Response, error) {
	return r.ApiService.ListWsV1beta1WorkspacesExecute(r)
}
...
func (a *WorkspacesWsV1beta1ApiService) ListWsV1beta1WorkspacesExecute(r ApiListWsV1beta1WorkspacesRequest) (WsV1beta1WorkspaceList, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  WsV1beta1WorkspaceList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesWsV1beta1ApiService.ListWsV1beta1Workspaces")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPutWsV1beta1WorkspaceRequest) WsV1beta1Workspace(wsV1beta1Workspace WsV1beta1Workspace) ApiPutWsV1beta1WorkspaceRequest {
	r.wsV1beta1Workspace = &wsV1beta1Workspace
	return r
}

func (r ApiPutWsV1beta1WorkspaceRequest) Execute() (WsV1beta1Workspace, *_nethttp.Response, error) {
	return r.ApiService.PutWsV1beta1WorkspaceExecute(r)
}
...
func (a *WorkspacesWsV1beta1ApiService) PutWsV1beta1WorkspaceExecute(r ApiPutWsV1beta1WorkspaceRequest) (WsV1beta1Workspace, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesWsV1beta1ApiService.PutWsV1beta1Workspace")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
