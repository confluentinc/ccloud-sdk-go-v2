...
// WsV1WorkspaceSpec The specification for the Workspace
type WsV1WorkspaceSpec struct {
	...
	Blocks *[]WsV1Block `json:"blocks,omitempty"`
...
// SetBlocks gets a reference to the given []WsV1Block and assigns it to the Blocks field.
...
func (o *WsV1WorkspaceSpec) Redact() {
...
func (o *WsV1WorkspaceSpec) recurseRedact(v interface{}) {
...
func (o WsV1WorkspaceSpec) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o WsV1WorkspaceSpec) MarshalJSON() ([]byte, error) {
...
type NullableWsV1WorkspaceSpec struct {
	value *WsV1WorkspaceSpec
	isSet bool
}

func (v NullableWsV1WorkspaceSpec) Get() *WsV1WorkspaceSpec {
	return v.value
}

func (v *NullableWsV1WorkspaceSpec) Set(val *WsV1WorkspaceSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableWsV1WorkspaceSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableWsV1WorkspaceSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWsV1WorkspaceSpec(val *WsV1WorkspaceSpec) *NullableWsV1WorkspaceSpec {
	return &NullableWsV1WorkspaceSpec{value: val, isSet: true}
}

func (v NullableWsV1WorkspaceSpec) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableWsV1WorkspaceSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
