...
type IamV2UpdateCertRequest struct {
	...
	// The uri from which to fetch the CRL for this certificate authority.
	CrlUri *string `json:"crl_uri,omitempty"`
	// The Base64 encoded string containing the CRL for this certificate authority.. Defaults to this over `crl_uri` if available.
...
// GetCrlUri returns the CrlUri field value if set, zero value otherwise.
func (o *IamV2UpdateCertRequest) GetCrlUri() string {
	if o == nil || o.CrlUri == nil {
		var ret string
		return ret
	}
	return *o.CrlUri
...
// GetCrlUriOk returns a tuple with the CrlUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IamV2UpdateCertRequest) GetCrlUriOk() (*string, bool) {
	if o == nil || o.CrlUri == nil {
		return nil, false
	}
	return o.CrlUri, true
}
...
// SetCrlUri gets a reference to the given string and assigns it to the CrlUri field.
