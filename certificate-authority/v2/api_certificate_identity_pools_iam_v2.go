...
type CertificateIdentityPoolsIamV2Api interface {
	...
	*/
	CreateIamV2CertificateIdentityPool(ctx _context.Context, providerId string) ApiCreateIamV2CertificateIdentityPoolRequest
	...
	*/
	DeleteIamV2CertificateIdentityPool(ctx _context.Context, providerId string, id string) ApiDeleteIamV2CertificateIdentityPoolRequest
	...
	*/
	GetIamV2CertificateIdentityPool(ctx _context.Context, providerId string, id string) ApiGetIamV2CertificateIdentityPoolRequest
	...
	*/
	ListIamV2CertificateIdentityPools(ctx _context.Context, providerId string) ApiListIamV2CertificateIdentityPoolsRequest
	...
	*/
	UpdateIamV2CertificateIdentityPool(ctx _context.Context, providerId string, id string) ApiUpdateIamV2CertificateIdentityPoolRequest
...
Make a request to create a certificate identity pool.
	...
	@return ApiCreateIamV2CertificateIdentityPoolRequest
*/
func (a *CertificateIdentityPoolsIamV2ApiService) CreateIamV2CertificateIdentityPool(ctx _context.Context, providerId string) ApiCreateIamV2CertificateIdentityPoolRequest {
	return ApiCreateIamV2CertificateIdentityPoolRequest{
		ApiService: a,
		ctx:        ctx,
...
func (a *CertificateIdentityPoolsIamV2ApiService) CreateIamV2CertificateIdentityPoolExecute(r ApiCreateIamV2CertificateIdentityPoolRequest) (IamV2CertificateIdentityPool, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/iam/v2/certificate-authorities/{provider_id}/identity-pools"
...
Make a request to delete a certificate identity pool.
	...
	@return ApiDeleteIamV2CertificateIdentityPoolRequest
*/
func (a *CertificateIdentityPoolsIamV2ApiService) DeleteIamV2CertificateIdentityPool(ctx _context.Context, providerId string, id string) ApiDeleteIamV2CertificateIdentityPoolRequest {
	return ApiDeleteIamV2CertificateIdentityPoolRequest{
		ApiService: a,
		ctx:        ctx,
		providerId: providerId,
...
func (a *CertificateIdentityPoolsIamV2ApiService) DeleteIamV2CertificateIdentityPoolExecute(r ApiDeleteIamV2CertificateIdentityPoolRequest) (IamV2CertificateIdentityPool, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/iam/v2/certificate-authorities/{provider_id}/identity-pools/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"provider_id"+"}", _neturl.PathEscape(parameterToString(r.providerId, "")), -1)
...
Make a request to read a certificate identity pool.
	...
	@return ApiGetIamV2CertificateIdentityPoolRequest
*/
func (a *CertificateIdentityPoolsIamV2ApiService) GetIamV2CertificateIdentityPool(ctx _context.Context, providerId string, id string) ApiGetIamV2CertificateIdentityPoolRequest {
	return ApiGetIamV2CertificateIdentityPoolRequest{
		ApiService: a,
		ctx:        ctx,
		providerId: providerId,
...
Retrieve a sorted, filtered, paginated list of all certificate identity pools.
	...
	@return ApiListIamV2CertificateIdentityPoolsRequest
*/
func (a *CertificateIdentityPoolsIamV2ApiService) ListIamV2CertificateIdentityPools(ctx _context.Context, providerId string) ApiListIamV2CertificateIdentityPoolsRequest {
	return ApiListIamV2CertificateIdentityPoolsRequest{
		ApiService: a,
		ctx:        ctx,
		providerId: providerId,
...
Make a request to update a certificate identity pool.
	...
	@return ApiUpdateIamV2CertificateIdentityPoolRequest
*/
func (a *CertificateIdentityPoolsIamV2ApiService) UpdateIamV2CertificateIdentityPool(ctx _context.Context, providerId string, id string) ApiUpdateIamV2CertificateIdentityPoolRequest {
	return ApiUpdateIamV2CertificateIdentityPoolRequest{
		ApiService: a,
		ctx:        ctx,
		providerId: providerId,
