...
// SetExternalIdentity gets a reference to the given string and assigns it to the ExternalIdentity field.
...
func (o *IamV2CertificateIdentityPool) Redact() {
	...
	o.recurseRedact(o.ExternalIdentity)
...
func (o IamV2CertificateIdentityPool) MarshalJSON() ([]byte, error) {
	...
	if o.ExternalIdentity != nil {
		toSerialize["external_identity"] = o.ExternalIdentity
	}
	if o.Filter != nil {
