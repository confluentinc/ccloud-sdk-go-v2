...
**CrlUri** | Pointer to **string** | The uri from which to fetch the CRL for this certificate authority | [optional] 
**CrlChain** | Pointer to **string** | The Base64 encoded string containing the CRL for this certificate authority. Defaults to this over &#x60;crl_uri&#x60; if available. | [optional] 
...
`func (o *IamV2CreateCertRequest) GetCrlUri() string`

GetCrlUri returns the CrlUri field if non-nil, zero value otherwise.

### GetCrlUriOk

`func (o *IamV2CreateCertRequest) GetCrlUriOk() (*string, bool)`

GetCrlUriOk returns a tuple with the CrlUri field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetCrlUri

`func (o *IamV2CreateCertRequest) SetCrlUri(v string)`

SetCrlUri sets CrlUri field to given value.

### HasCrlUri

`func (o *IamV2CreateCertRequest) HasCrlUri() bool`

HasCrlUri returns a boolean if a field has been set.
