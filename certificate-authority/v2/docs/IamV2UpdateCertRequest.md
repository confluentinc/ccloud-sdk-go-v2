...
`func (o *IamV2UpdateCertRequest) GetCrlUri() string`

GetCrlUri returns the CrlUri field if non-nil, zero value otherwise.

### GetCrlUriOk

`func (o *IamV2UpdateCertRequest) GetCrlUriOk() (*string, bool)`
...
`func (o *IamV2UpdateCertRequest) SetCrlUri(v string)`

SetCrlUri sets CrlUri field to given value.

### HasCrlUri

`func (o *IamV2UpdateCertRequest) HasCrlUri() bool`
