...
type CostsBillingV1alpha1Api interface {
	...
	*/
	...
	// ListBillingV1alpha1CostsExecute executes the request
	//  @return BillingV1alpha1CostList
	ListBillingV1alpha1CostsExecute(r ApiListBillingV1alpha1CostsRequest) (BillingV1alpha1CostList, *_nethttp.Response, error)
}

// CostsBillingV1alpha1ApiService CostsBillingV1alpha1Api service
...
func (r ApiListBillingV1alpha1CostsRequest) StartDate(startDate string) ApiListBillingV1alpha1CostsRequest {
...
func (r ApiListBillingV1alpha1CostsRequest) Execute() (BillingV1alpha1CostList, *_nethttp.Response, error) {
	return r.ApiService.ListBillingV1alpha1CostsExecute(r)
}
...
//  @return BillingV1alpha1CostList
func (a *CostsBillingV1alpha1ApiService) ListBillingV1alpha1CostsExecute(r ApiListBillingV1alpha1CostsRequest) (BillingV1alpha1CostList, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  BillingV1alpha1CostList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CostsBillingV1alpha1ApiService.ListBillingV1alpha1Costs")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/billing/v1alpha1/costs"
