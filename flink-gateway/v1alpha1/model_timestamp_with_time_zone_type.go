...
// TimestampWithTimeZoneType struct for TimestampWithTimeZoneType
...
func NewTimestampWithTimeZoneType(nullable bool, type_ string) *TimestampWithTimeZoneType {
	this := TimestampWithTimeZoneType{}
...
func (o *TimestampWithTimeZoneType) Redact() {
    o.recurseRedact(&o.Nullable)
    o.recurseRedact(&o.Type)
}

func (o *TimestampWithTimeZoneType) recurseRedact(v interface{}) {
...
func (o TimestampWithTimeZoneType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o TimestampWithTimeZoneType) MarshalJSON() ([]byte, error) {
...
type NullableTimestampWithTimeZoneType struct {
	value *TimestampWithTimeZoneType
	isSet bool
}

func (v NullableTimestampWithTimeZoneType) Get() *TimestampWithTimeZoneType {
	return v.value
}

func (v *NullableTimestampWithTimeZoneType) Set(val *TimestampWithTimeZoneType) {
	v.value = val
	v.isSet = true
}

func (v NullableTimestampWithTimeZoneType) IsSet() bool {
	return v.isSet
}

func (v *NullableTimestampWithTimeZoneType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimestampWithTimeZoneType(val *TimestampWithTimeZoneType) *NullableTimestampWithTimeZoneType {
	return &NullableTimestampWithTimeZoneType{value: val, isSet: true}
}

func (v NullableTimestampWithTimeZoneType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimestampWithTimeZoneType) UnmarshalJSON(src []byte) error {
	v.isSet = true
