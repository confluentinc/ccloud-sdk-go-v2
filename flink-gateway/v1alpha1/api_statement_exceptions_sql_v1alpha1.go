...
type StatementExceptionsSqlV1alpha1Api interface {
	...
	/*
	GetSqlV1alpha1StatementExceptions List of Statements
...
func (a *StatementExceptionsSqlV1alpha1ApiService) GetSqlV1alpha1StatementExceptionsExecute(r ApiGetSqlV1alpha1StatementExceptionsRequest) (SqlV1alpha1StatementExceptionList, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  SqlV1alpha1StatementExceptionList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatementExceptionsSqlV1alpha1ApiService.GetSqlV1alpha1StatementExceptions")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/sql/v1alpha1/environments/{environment_id}/statements/{statement_name}/exceptions"
