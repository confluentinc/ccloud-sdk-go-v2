...
func (o *SqlV1alpha1StatementExceptionList) GetData() []SqlV1alpha1StatementException {
	if o == nil {
		var ret []SqlV1alpha1StatementException
		return ret
	}
...
func (o *SqlV1alpha1StatementExceptionList) recurseRedact(v interface{}) {
...
func (o SqlV1alpha1StatementExceptionList) zeroField(v interface{}) {
...
type NullableSqlV1alpha1StatementExceptionList struct {
	value *SqlV1alpha1StatementExceptionList
	isSet bool
}
...
func NewNullableSqlV1alpha1StatementExceptionList(val *SqlV1alpha1StatementExceptionList) *NullableSqlV1alpha1StatementExceptionList {
	return &NullableSqlV1alpha1StatementExceptionList{value: val, isSet: true}
}
