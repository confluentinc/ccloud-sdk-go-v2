...
// DoubleType struct for DoubleType
...
func (o *DoubleType) Redact() {
    o.recurseRedact(&o.Nullable)
    o.recurseRedact(&o.Type)
}

func (o *DoubleType) recurseRedact(v interface{}) {
...
func (o DoubleType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o DoubleType) MarshalJSON() ([]byte, error) {
...
type NullableDoubleType struct {
	value *DoubleType
	isSet bool
}

func (v NullableDoubleType) Get() *DoubleType {
	return v.value
}

func (v *NullableDoubleType) Set(val *DoubleType) {
	v.value = val
	v.isSet = true
}

func (v NullableDoubleType) IsSet() bool {
	return v.isSet
}

func (v *NullableDoubleType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDoubleType(val *DoubleType) *NullableDoubleType {
	return &NullableDoubleType{value: val, isSet: true}
}

func (v NullableDoubleType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDoubleType) UnmarshalJSON(src []byte) error {
	v.isSet = true
