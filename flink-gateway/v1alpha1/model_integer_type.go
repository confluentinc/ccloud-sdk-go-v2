...
func (o *IntegerType) Redact() {
    o.recurseRedact(&o.Nullable)
    o.recurseRedact(&o.Type)
}

func (o *IntegerType) recurseRedact(v interface{}) {
...
func (o IntegerType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o IntegerType) MarshalJSON() ([]byte, error) {
...
func (v NullableIntegerType) Get() *IntegerType {
	return v.value
}

func (v *NullableIntegerType) Set(val *IntegerType) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegerType) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegerType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegerType(val *IntegerType) *NullableIntegerType {
	return &NullableIntegerType{value: val, isSet: true}
}

func (v NullableIntegerType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegerType) UnmarshalJSON(src []byte) error {
	v.isSet = true
