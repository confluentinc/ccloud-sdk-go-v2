...
func (o CharType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o CharType) MarshalJSON() ([]byte, error) {
...
type NullableCharType struct {
	value *CharType
	isSet bool
}

func (v NullableCharType) Get() *CharType {
	return v.value
}

func (v *NullableCharType) Set(val *CharType) {
	v.value = val
	v.isSet = true
}

func (v NullableCharType) IsSet() bool {
	return v.isSet
}

func (v *NullableCharType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCharType(val *CharType) *NullableCharType {
	return &NullableCharType{value: val, isSet: true}
}

func (v NullableCharType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCharType) UnmarshalJSON(src []byte) error {
	v.isSet = true
