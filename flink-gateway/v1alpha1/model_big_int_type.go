...
// BigIntType struct for BigIntType
...
func (o *BigIntType) Redact() {
    o.recurseRedact(&o.Nullable)
    o.recurseRedact(&o.Type)
}

func (o *BigIntType) recurseRedact(v interface{}) {
...
func (o BigIntType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o BigIntType) MarshalJSON() ([]byte, error) {
...
type NullableBigIntType struct {
	value *BigIntType
	isSet bool
}

func (v NullableBigIntType) Get() *BigIntType {
	return v.value
}

func (v *NullableBigIntType) Set(val *BigIntType) {
	v.value = val
	v.isSet = true
}

func (v NullableBigIntType) IsSet() bool {
	return v.isSet
}

func (v *NullableBigIntType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBigIntType(val *BigIntType) *NullableBigIntType {
	return &NullableBigIntType{value: val, isSet: true}
}

func (v NullableBigIntType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBigIntType) UnmarshalJSON(src []byte) error {
	v.isSet = true
