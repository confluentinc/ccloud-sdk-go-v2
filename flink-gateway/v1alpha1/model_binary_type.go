...
// BinaryType struct for BinaryType
...
func (o BinaryType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o BinaryType) MarshalJSON() ([]byte, error) {
