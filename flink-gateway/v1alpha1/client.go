...
// APIClient manages communication with the SQL API v1alpha1 API v0.0.1
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.StatementExceptionsSqlV1alpha1Api = (*StatementExceptionsSqlV1alpha1ApiService)(&c.common)
