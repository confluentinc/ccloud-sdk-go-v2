...
func (o *DateType) Redact() {
    o.recurseRedact(&o.Nullable)
    o.recurseRedact(&o.Type)
}

func (o *DateType) recurseRedact(v interface{}) {
...
func (o DateType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o DateType) MarshalJSON() ([]byte, error) {
...
func (v NullableDateType) Get() *DateType {
	return v.value
}

func (v *NullableDateType) Set(val *DateType) {
	v.value = val
	v.isSet = true
}

func (v NullableDateType) IsSet() bool {
	return v.isSet
}

func (v *NullableDateType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDateType(val *DateType) *NullableDateType {
	return &NullableDateType{value: val, isSet: true}
}

func (v NullableDateType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDateType) UnmarshalJSON(src []byte) error {
	v.isSet = true
