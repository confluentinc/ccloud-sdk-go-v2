...
// SmallIntType struct for SmallIntType
...
func (o *SmallIntType) Redact() {
    o.recurseRedact(&o.Nullable)
    o.recurseRedact(&o.Type)
}

func (o *SmallIntType) recurseRedact(v interface{}) {
...
func (o SmallIntType) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o SmallIntType) MarshalJSON() ([]byte, error) {
...
type NullableSmallIntType struct {
	value *SmallIntType
	isSet bool
}

func (v NullableSmallIntType) Get() *SmallIntType {
	return v.value
}

func (v *NullableSmallIntType) Set(val *SmallIntType) {
	v.value = val
	v.isSet = true
}

func (v NullableSmallIntType) IsSet() bool {
	return v.isSet
}

func (v *NullableSmallIntType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmallIntType(val *SmallIntType) *NullableSmallIntType {
	return &NullableSmallIntType{value: val, isSet: true}
}

func (v NullableSmallIntType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmallIntType) UnmarshalJSON(src []byte) error {
	v.isSet = true
