...
// SqlV1beta1ScalingStatus Scaling status for this statement.
type SqlV1beta1ScalingStatus struct {
...
func (o *SqlV1beta1ScalingStatus) Redact() {
	o.recurseRedact(o.ScalingState)
	o.recurseRedact(o.LastUpdated)
}

func (o *SqlV1beta1ScalingStatus) recurseRedact(v interface{}) {
...
func (o SqlV1beta1ScalingStatus) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o SqlV1beta1ScalingStatus) MarshalJSON() ([]byte, error) {
...
type NullableSqlV1beta1ScalingStatus struct {
	value *SqlV1beta1ScalingStatus
	isSet bool
}

func (v NullableSqlV1beta1ScalingStatus) Get() *SqlV1beta1ScalingStatus {
	return v.value
}

func (v *NullableSqlV1beta1ScalingStatus) Set(val *SqlV1beta1ScalingStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSqlV1beta1ScalingStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSqlV1beta1ScalingStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSqlV1beta1ScalingStatus(val *SqlV1beta1ScalingStatus) *NullableSqlV1beta1ScalingStatus {
	return &NullableSqlV1beta1ScalingStatus{value: val, isSet: true}
}

func (v NullableSqlV1beta1ScalingStatus) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableSqlV1beta1ScalingStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
