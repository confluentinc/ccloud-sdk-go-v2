...
// SqlV1MaterializedTableList A list of Materialized Table resources.
type SqlV1MaterializedTableList struct {
	ApiVersion string   `json:"api_version,omitempty"`
	Kind       string   `json:"kind,omitempty"`
	Metadata   ListMeta `json:"metadata,omitempty"`
	// A data property that contains an array of resource items. Each entry in the array is a separate resource.
	Data []SqlV1MaterializedTable `json:"data,omitempty"`
}
...
func NewSqlV1MaterializedTableList(apiVersion string, kind string, metadata ListMeta, data []SqlV1MaterializedTable) *SqlV1MaterializedTableList {
	this := SqlV1MaterializedTableList{}
...
func (o *SqlV1MaterializedTableList) GetData() []SqlV1MaterializedTable {
	if o == nil {
		var ret []SqlV1MaterializedTable
		return ret
	}
...
func (o *SqlV1MaterializedTableList) Redact() {
...
func (o *SqlV1MaterializedTableList) recurseRedact(v interface{}) {
...
func (o SqlV1MaterializedTableList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o SqlV1MaterializedTableList) MarshalJSON() ([]byte, error) {
...
type NullableSqlV1MaterializedTableList struct {
	value *SqlV1MaterializedTableList
	isSet bool
}

func (v NullableSqlV1MaterializedTableList) Get() *SqlV1MaterializedTableList {
	return v.value
}

func (v *NullableSqlV1MaterializedTableList) Set(val *SqlV1MaterializedTableList) {
	v.value = val
	v.isSet = true
}

func (v NullableSqlV1MaterializedTableList) IsSet() bool {
	return v.isSet
}

func (v *NullableSqlV1MaterializedTableList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSqlV1MaterializedTableList(val *SqlV1MaterializedTableList) *NullableSqlV1MaterializedTableList {
	return &NullableSqlV1MaterializedTableList{value: val, isSet: true}
}

func (v NullableSqlV1MaterializedTableList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableSqlV1MaterializedTableList) UnmarshalJSON(src []byte) error {
	v.isSet = true
