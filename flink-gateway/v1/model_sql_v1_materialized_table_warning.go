...
// SqlV1MaterializedTableWarning Represents a non-fatal issue encountered during materialized table processing.
type SqlV1MaterializedTableWarning struct {
...
func NewSqlV1MaterializedTableWarning(severity string, createdAt time.Time, reason string, message string) *SqlV1MaterializedTableWarning {
	this := SqlV1MaterializedTableWarning{}
...
func (o *SqlV1MaterializedTableWarning) Redact() {
...
func (o *SqlV1MaterializedTableWarning) recurseRedact(v interface{}) {
...
func (o SqlV1MaterializedTableWarning) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o SqlV1MaterializedTableWarning) MarshalJSON() ([]byte, error) {
...
type NullableSqlV1MaterializedTableWarning struct {
	value *SqlV1MaterializedTableWarning
	isSet bool
}

func (v NullableSqlV1MaterializedTableWarning) Get() *SqlV1MaterializedTableWarning {
	return v.value
}

func (v *NullableSqlV1MaterializedTableWarning) Set(val *SqlV1MaterializedTableWarning) {
	v.value = val
	v.isSet = true
}

func (v NullableSqlV1MaterializedTableWarning) IsSet() bool {
	return v.isSet
}

func (v *NullableSqlV1MaterializedTableWarning) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSqlV1MaterializedTableWarning(val *SqlV1MaterializedTableWarning) *NullableSqlV1MaterializedTableWarning {
	return &NullableSqlV1MaterializedTableWarning{value: val, isSet: true}
}

func (v NullableSqlV1MaterializedTableWarning) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableSqlV1MaterializedTableWarning) UnmarshalJSON(src []byte) error {
	v.isSet = true
