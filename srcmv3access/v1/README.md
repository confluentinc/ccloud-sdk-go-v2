...
------------ | ------------- | ------------- | -------------
*AccessesSrcmV3Api* | [**GetSrcmV3Access**](docs/AccessesSrcmV3Api.md#getsrcmv3access) | **Get** /srcm/v3/clusters/{id}/access | Read an Access
...
## Documentation For Models
 ...
 - [SrcmV3Access](docs/SrcmV3Access.md)
 - [SrcmV3AccessSpec](docs/SrcmV3AccessSpec.md)
