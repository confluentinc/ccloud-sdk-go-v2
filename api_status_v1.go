...
func (r apiListConnectv1ConnectorTasksRequest) Execute() ([]map[string]interface{}, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "StatusV1ApiService.ListConnectv1ConnectorTasks")
	if err != nil {
...
func (r apiReadConnectv1ConnectorStatusRequest) Execute() (InlineResponse2001, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "StatusV1ApiService.ReadConnectv1ConnectorStatus")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
