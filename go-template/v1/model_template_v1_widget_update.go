...
type TemplateV1WidgetUpdate struct {
	...
	Spec     *TemplateV1WidgetSpecUpdate `json:"spec,omitempty"`
	Status   *TemplateV1WidgetStatus     `json:"status,omitempty"`
}
...
func (o *TemplateV1WidgetUpdate) GetSpec() TemplateV1WidgetSpecUpdate {
	if o == nil || o.Spec == nil {
		var ret TemplateV1WidgetSpecUpdate
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given TemplateV1WidgetSpecUpdate and assigns it to the Spec field.
...
func (o *TemplateV1WidgetUpdate) GetStatus() TemplateV1WidgetStatus {
	if o == nil || o.Status == nil {
		var ret TemplateV1WidgetStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given TemplateV1WidgetStatus and assigns it to the Status field.
func (o *TemplateV1WidgetUpdate) SetStatus(v TemplateV1WidgetStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *TemplateV1WidgetUpdate) Redact() {
...
func (o *TemplateV1WidgetUpdate) recurseRedact(v interface{}) {
...
func (o TemplateV1WidgetUpdate) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o TemplateV1WidgetUpdate) MarshalJSON() ([]byte, error) {
...
type NullableTemplateV1WidgetUpdate struct {
	value *TemplateV1WidgetUpdate
	isSet bool
}

func (v NullableTemplateV1WidgetUpdate) Get() *TemplateV1WidgetUpdate {
	return v.value
}

func (v *NullableTemplateV1WidgetUpdate) Set(val *TemplateV1WidgetUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateV1WidgetUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateV1WidgetUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateV1WidgetUpdate(val *TemplateV1WidgetUpdate) *NullableTemplateV1WidgetUpdate {
	return &NullableTemplateV1WidgetUpdate{value: val, isSet: true}
}

func (v NullableTemplateV1WidgetUpdate) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableTemplateV1WidgetUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
