...
// NetworkingV1GatewayList A Gateway represents a slice of traffic capacity in a region that is reserved for a customer.   ## The Gateways Model <SchemaDefinition schemaRef=\"#/components/schemas/networking.v1.Gateway\" />
