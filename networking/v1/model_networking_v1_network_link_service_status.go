...
func (o *NetworkingV1NetworkLinkServiceStatus) recurseRedact(v interface{}) {
...
func (o NetworkingV1NetworkLinkServiceStatus) zeroField(v interface{}) {
...
type NullableNetworkingV1NetworkLinkServiceStatus struct {
	value *NetworkingV1NetworkLinkServiceStatus
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceStatus) Get() *NetworkingV1NetworkLinkServiceStatus {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceStatus) Set(val *NetworkingV1NetworkLinkServiceStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceStatus) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableNetworkingV1NetworkLinkServiceStatus(val *NetworkingV1NetworkLinkServiceStatus) *NullableNetworkingV1NetworkLinkServiceStatus {
	return &NullableNetworkingV1NetworkLinkServiceStatus{value: val, isSet: true}
}
