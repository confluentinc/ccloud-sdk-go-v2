...
func NewNetworkingV1NetworkLinkServiceAssociationStatus(phase string) *NetworkingV1NetworkLinkServiceAssociationStatus {
	this := NetworkingV1NetworkLinkServiceAssociationStatus{}
	this.Phase = phase
	return &this
}
...
func (o *NetworkingV1NetworkLinkServiceAssociationStatus) Redact() {
	o.recurseRedact(&o.Phase)
	o.recurseRedact(o.ErrorCode)
	o.recurseRedact(o.ErrorMessage)
}

func (o *NetworkingV1NetworkLinkServiceAssociationStatus) recurseRedact(v interface{}) {
...
func (o NetworkingV1NetworkLinkServiceAssociationStatus) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingV1NetworkLinkServiceAssociationStatus) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingV1NetworkLinkServiceAssociationStatus struct {
	value *NetworkingV1NetworkLinkServiceAssociationStatus
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationStatus) Get() *NetworkingV1NetworkLinkServiceAssociationStatus {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationStatus) Set(val *NetworkingV1NetworkLinkServiceAssociationStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceAssociationStatus(val *NetworkingV1NetworkLinkServiceAssociationStatus) *NullableNetworkingV1NetworkLinkServiceAssociationStatus {
	return &NullableNetworkingV1NetworkLinkServiceAssociationStatus{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
