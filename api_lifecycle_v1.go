...
type apiPauseConnectv1ConnectorRequest struct {
	...
	apiService *LifecycleV1ApiService
...
func (r apiPauseConnectv1ConnectorRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LifecycleV1ApiService.PauseConnectv1Connector")
	if err != nil {
...
func (r apiResumeConnectv1ConnectorRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "LifecycleV1ApiService.ResumeConnectv1Connector")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}
