...
// StreamCatalogV2CollibraDomainsRequest Defines the request parameters for retrieving domain information, including authentication details.
type StreamCatalogV2CollibraDomainsRequest struct {
	...
	// The URL provided is specific to Confluent's Collibra account.
...
func NewStreamCatalogV2CollibraDomainsRequest() *StreamCatalogV2CollibraDomainsRequest {
	this := StreamCatalogV2CollibraDomainsRequest{}
	return &this
}
...
func (o *StreamCatalogV2CollibraDomainsRequest) Redact() {
	o.recurseRedact(o.ApiVersion)
	o.recurseRedact(o.Kind)
	o.recurseRedact(o.Id)
	o.recurseRedact(o.Metadata)
	o.recurseRedact(o.Url)
	o.recurseRedact(o.Username)
	o.recurseRedact(o.Password)
}

func (o *StreamCatalogV2CollibraDomainsRequest) recurseRedact(v interface{}) {
...
func (o StreamCatalogV2CollibraDomainsRequest) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o StreamCatalogV2CollibraDomainsRequest) MarshalJSON() ([]byte, error) {
...
type NullableStreamCatalogV2CollibraDomainsRequest struct {
	value *StreamCatalogV2CollibraDomainsRequest
	isSet bool
}

func (v NullableStreamCatalogV2CollibraDomainsRequest) Get() *StreamCatalogV2CollibraDomainsRequest {
	return v.value
}

func (v *NullableStreamCatalogV2CollibraDomainsRequest) Set(val *StreamCatalogV2CollibraDomainsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamCatalogV2CollibraDomainsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamCatalogV2CollibraDomainsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamCatalogV2CollibraDomainsRequest(val *StreamCatalogV2CollibraDomainsRequest) *NullableStreamCatalogV2CollibraDomainsRequest {
	return &NullableStreamCatalogV2CollibraDomainsRequest{value: val, isSet: true}
}

func (v NullableStreamCatalogV2CollibraDomainsRequest) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableStreamCatalogV2CollibraDomainsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
