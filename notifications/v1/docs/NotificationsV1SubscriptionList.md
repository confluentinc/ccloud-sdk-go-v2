...
**Data** | [**[]NotificationsV1Subscription**](NotificationsV1Subscription.md) | A data property that contains an array of resource items. Each entry in the array is a separate resource. | 
