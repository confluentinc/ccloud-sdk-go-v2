...
**Data** | [**[]NotificationsV1NotificationType**](NotificationsV1NotificationType.md) | A data property that contains an array of resource items. Each entry in the array is a separate resource. | 
