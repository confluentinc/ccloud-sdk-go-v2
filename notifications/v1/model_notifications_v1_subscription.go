...
func NewNotificationsV1Subscription() *NotificationsV1Subscription {
	this := NotificationsV1Subscription{}
	return &this
}
...
func (o *NotificationsV1Subscription) Redact() {
...
func (o *NotificationsV1Subscription) recurseRedact(v interface{}) {
...
func (o NotificationsV1Subscription) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o NotificationsV1Subscription) MarshalJSON() ([]byte, error) {
...
type NullableNotificationsV1Subscription struct {
	value *NotificationsV1Subscription
	isSet bool
}

func (v NullableNotificationsV1Subscription) Get() *NotificationsV1Subscription {
	return v.value
}

func (v *NullableNotificationsV1Subscription) Set(val *NotificationsV1Subscription) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1Subscription) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1Subscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1Subscription(val *NotificationsV1Subscription) *NullableNotificationsV1Subscription {
	return &NullableNotificationsV1Subscription{value: val, isSet: true}
}

func (v NullableNotificationsV1Subscription) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableNotificationsV1Subscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
