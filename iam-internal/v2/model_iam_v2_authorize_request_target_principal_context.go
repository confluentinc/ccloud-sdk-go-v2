...
// IamV2AuthorizeRequestTargetPrincipalContext context related to principal
type IamV2AuthorizeRequestTargetPrincipalContext struct {
...
func NewIamV2AuthorizeRequestTargetPrincipalContext() *IamV2AuthorizeRequestTargetPrincipalContext {
	this := IamV2AuthorizeRequestTargetPrincipalContext{}
	return &this
}
...
func (o *IamV2AuthorizeRequestTargetPrincipalContext) Redact() {
	o.recurseRedact(o.PrincipalIds)
}

func (o *IamV2AuthorizeRequestTargetPrincipalContext) recurseRedact(v interface{}) {
...
func (o IamV2AuthorizeRequestTargetPrincipalContext) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o IamV2AuthorizeRequestTargetPrincipalContext) MarshalJSON() ([]byte, error) {
...
type NullableIamV2AuthorizeRequestTargetPrincipalContext struct {
	value *IamV2AuthorizeRequestTargetPrincipalContext
	isSet bool
}

func (v NullableIamV2AuthorizeRequestTargetPrincipalContext) Get() *IamV2AuthorizeRequestTargetPrincipalContext {
	return v.value
}

func (v *NullableIamV2AuthorizeRequestTargetPrincipalContext) Set(val *IamV2AuthorizeRequestTargetPrincipalContext) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2AuthorizeRequestTargetPrincipalContext) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2AuthorizeRequestTargetPrincipalContext) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2AuthorizeRequestTargetPrincipalContext(val *IamV2AuthorizeRequestTargetPrincipalContext) *NullableIamV2AuthorizeRequestTargetPrincipalContext {
	return &NullableIamV2AuthorizeRequestTargetPrincipalContext{value: val, isSet: true}
}

func (v NullableIamV2AuthorizeRequestTargetPrincipalContext) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableIamV2AuthorizeRequestTargetPrincipalContext) UnmarshalJSON(src []byte) error {
	v.isSet = true
