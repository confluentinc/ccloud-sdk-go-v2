...
------------ | ------------- | ------------- | -------------
**EnableCompaction** | Pointer to **bool** | This flag determines whether to enable compaction for the Tableflow enabled topic. Deprecated | [optional] [readonly] 
**EnablePartitioning** | Pointer to **bool** | This flag determines whether to enable partitioning for the Tableflow enabled topic. Deprecated | [optional] [readonly] 
