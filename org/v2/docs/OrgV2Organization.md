...
**ScimEnabled** | Pointer to **bool** | The flag to toggle SCIM user provisioning for an SSO-enabled organization.  Note - The attribute is in a [Limited Availability lifecycle stage](https://docs.confluent.io/cloud/current/api.html#section/Versioning/API-Lifecycle-Policy)  | [optional] 
