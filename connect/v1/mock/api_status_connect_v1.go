...
// Source: api_status_connect_v1.go
...
type StatusConnectV1Api struct {
	...
	ListConnectv1ConnectorTasksFunc func(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorTasksRequest

	lockListConnectv1ConnectorTasksExecute sync.Mutex
	ListConnectv1ConnectorTasksExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorTasksRequest) (github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ConnectV1Connectors, *net_http.Response, error)

	lockReadConnectv1ConnectorStatus sync.Mutex
	ReadConnectv1ConnectorStatusFunc func(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiReadConnectv1ConnectorStatusRequest

	lockReadConnectv1ConnectorStatusExecute sync.Mutex
	ReadConnectv1ConnectorStatusExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiReadConnectv1ConnectorStatusRequest) (github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.InlineResponse2001, *net_http.Response, error)
	...
	calls struct {
		...
		ListConnectv1ConnectorTasksExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorTasksRequest
		}
		...
		ReadConnectv1ConnectorStatusExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiReadConnectv1ConnectorStatusRequest
		}
	}
}

// ListConnectv1ConnectorTasks mocks base method by wrapping the associated func.
func (m *StatusConnectV1Api) ListConnectv1ConnectorTasks(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorTasksRequest {
	...
	if m.ListConnectv1ConnectorTasksFunc == nil {
		panic("mocker: StatusConnectV1Api.ListConnectv1ConnectorTasksFunc is nil but StatusConnectV1Api.ListConnectv1ConnectorTasks was called.")
	}
...
func (m *StatusConnectV1Api) ListConnectv1ConnectorTasksExecute(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorTasksRequest) (github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ConnectV1Connectors, *net_http.Response, error) {
	...
	if m.ListConnectv1ConnectorTasksExecuteFunc == nil {
		panic("mocker: StatusConnectV1Api.ListConnectv1ConnectorTasksExecuteFunc is nil but StatusConnectV1Api.ListConnectv1ConnectorTasksExecute was called.")
	}
...
func (m *StatusConnectV1Api) ReadConnectv1ConnectorStatus(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiReadConnectv1ConnectorStatusRequest {
	...
	if m.ReadConnectv1ConnectorStatusFunc == nil {
		panic("mocker: StatusConnectV1Api.ReadConnectv1ConnectorStatusFunc is nil but StatusConnectV1Api.ReadConnectv1ConnectorStatus was called.")
	}
...
func (m *StatusConnectV1Api) ReadConnectv1ConnectorStatusExecute(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiReadConnectv1ConnectorStatusRequest) (github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.InlineResponse2001, *net_http.Response, error) {
	...
	if m.ReadConnectv1ConnectorStatusExecuteFunc == nil {
		panic("mocker: StatusConnectV1Api.ReadConnectv1ConnectorStatusExecuteFunc is nil but StatusConnectV1Api.ReadConnectv1ConnectorStatusExecute was called.")
	}
