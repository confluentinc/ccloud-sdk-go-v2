...
type ManagedConnectorPluginsConnectV1Api struct {
	...
	ListConnectv1ConnectorPluginsFunc func(ctx context.Context, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorPluginsRequest

	lockListConnectv1ConnectorPluginsExecute sync.Mutex
	ListConnectv1ConnectorPluginsExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorPluginsRequest) ([]github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.InlineResponse2002, *net_http.Response, error)

	lockValidateConnectv1ConnectorPlugin sync.Mutex
	ValidateConnectv1ConnectorPluginFunc func(ctx context.Context, pluginName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiValidateConnectv1ConnectorPluginRequest

	lockValidateConnectv1ConnectorPluginExecute sync.Mutex
	ValidateConnectv1ConnectorPluginExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiValidateConnectv1ConnectorPluginRequest) (github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.InlineResponse2003, *net_http.Response, error)
	...
	calls struct {
		...
		ListConnectv1ConnectorPluginsExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorPluginsRequest
		}
		...
		ValidateConnectv1ConnectorPluginExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiValidateConnectv1ConnectorPluginRequest
		}
	}
}

// ListConnectv1ConnectorPlugins mocks base method by wrapping the associated func.
func (m *ManagedConnectorPluginsConnectV1Api) ListConnectv1ConnectorPlugins(ctx context.Context, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorPluginsRequest {
...
func (m *ManagedConnectorPluginsConnectV1Api) ListConnectv1ConnectorPluginsExecute(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiListConnectv1ConnectorPluginsRequest) ([]github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.InlineResponse2002, *net_http.Response, error) {
...
func (m *ManagedConnectorPluginsConnectV1Api) ValidateConnectv1ConnectorPlugin(ctx context.Context, pluginName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiValidateConnectv1ConnectorPluginRequest {
...
func (m *ManagedConnectorPluginsConnectV1Api) ValidateConnectv1ConnectorPluginExecute(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiValidateConnectv1ConnectorPluginRequest) (github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.InlineResponse2003, *net_http.Response, error) {
