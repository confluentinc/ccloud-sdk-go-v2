...
// Source: api_lifecycle_connect_v1.go
...
type LifecycleConnectV1Api struct {
	...
	PauseConnectv1ConnectorFunc func(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiPauseConnectv1ConnectorRequest

	lockPauseConnectv1ConnectorExecute sync.Mutex
	PauseConnectv1ConnectorExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiPauseConnectv1ConnectorRequest) (*net_http.Response, error)

	lockResumeConnectv1Connector sync.Mutex
	ResumeConnectv1ConnectorFunc func(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiResumeConnectv1ConnectorRequest

	lockResumeConnectv1ConnectorExecute sync.Mutex
	ResumeConnectv1ConnectorExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiResumeConnectv1ConnectorRequest) (*net_http.Response, error)
	...
	calls struct {
		...
		PauseConnectv1ConnectorExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiPauseConnectv1ConnectorRequest
		}
		...
		ResumeConnectv1ConnectorExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiResumeConnectv1ConnectorRequest
		}
	}
}

// PauseConnectv1Connector mocks base method by wrapping the associated func.
func (m *LifecycleConnectV1Api) PauseConnectv1Connector(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiPauseConnectv1ConnectorRequest {
	m.lockPauseConnectv1Connector.Lock()
	defer m.lockPauseConnectv1Connector.Unlock()

	if m.PauseConnectv1ConnectorFunc == nil {
		panic("mocker: LifecycleConnectV1Api.PauseConnectv1ConnectorFunc is nil but LifecycleConnectV1Api.PauseConnectv1Connector was called.")
	}
...
func (m *LifecycleConnectV1Api) PauseConnectv1ConnectorExecute(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiPauseConnectv1ConnectorRequest) (*net_http.Response, error) {
	...
	if m.PauseConnectv1ConnectorExecuteFunc == nil {
		panic("mocker: LifecycleConnectV1Api.PauseConnectv1ConnectorExecuteFunc is nil but LifecycleConnectV1Api.PauseConnectv1ConnectorExecute was called.")
	}
...
func (m *LifecycleConnectV1Api) ResumeConnectv1Connector(ctx context.Context, connectorName, environmentId, kafkaClusterId string) github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiResumeConnectv1ConnectorRequest {
	m.lockResumeConnectv1Connector.Lock()
	defer m.lockResumeConnectv1Connector.Unlock()

	if m.ResumeConnectv1ConnectorFunc == nil {
		panic("mocker: LifecycleConnectV1Api.ResumeConnectv1ConnectorFunc is nil but LifecycleConnectV1Api.ResumeConnectv1Connector was called.")
	}
...
func (m *LifecycleConnectV1Api) ResumeConnectv1ConnectorExecute(r github_com_confluentinc_ccloud_sdk_go_v2_internal_connect_v1.ApiResumeConnectv1ConnectorRequest) (*net_http.Response, error) {
	...
	if m.ResumeConnectv1ConnectorExecuteFunc == nil {
		panic("mocker: LifecycleConnectV1Api.ResumeConnectv1ConnectorExecuteFunc is nil but LifecycleConnectV1Api.ResumeConnectv1ConnectorExecute was called.")
	}
