...
// NetworkingAdminV1AwsPeering AWS VPC Peering.
type NetworkingAdminV1AwsPeering struct {
	// Peering kind type.
...
func NewNetworkingAdminV1AwsPeering(kind string, account string, vpc string, routes []string, customerRegion string) *NetworkingAdminV1AwsPeering {
	this := NetworkingAdminV1AwsPeering{}
	this.Kind = kind
...
func (o *NetworkingAdminV1AwsPeering) Redact() {
...
func (o *NetworkingAdminV1AwsPeering) recurseRedact(v interface{}) {
...
func (o NetworkingAdminV1AwsPeering) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingAdminV1AwsPeering) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingAdminV1AwsPeering struct {
	value *NetworkingAdminV1AwsPeering
	isSet bool
}

func (v NullableNetworkingAdminV1AwsPeering) Get() *NetworkingAdminV1AwsPeering {
	return v.value
}

func (v *NullableNetworkingAdminV1AwsPeering) Set(val *NetworkingAdminV1AwsPeering) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingAdminV1AwsPeering) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingAdminV1AwsPeering) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingAdminV1AwsPeering(val *NetworkingAdminV1AwsPeering) *NullableNetworkingAdminV1AwsPeering {
	return &NullableNetworkingAdminV1AwsPeering{value: val, isSet: true}
}

func (v NullableNetworkingAdminV1AwsPeering) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingAdminV1AwsPeering) UnmarshalJSON(src []byte) error {
	v.isSet = true
