...
// NetworkingAdminV1TransitGatewayAttachmentStatus The status of the Transit Gateway Attachment
type NetworkingAdminV1TransitGatewayAttachmentStatus struct {
...
func NewNetworkingAdminV1TransitGatewayAttachmentStatus(phase string) *NetworkingAdminV1TransitGatewayAttachmentStatus {
	this := NetworkingAdminV1TransitGatewayAttachmentStatus{}
	this.Phase = phase
	return &this
}
...
func (o NetworkingAdminV1TransitGatewayAttachmentStatus) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingAdminV1TransitGatewayAttachmentStatus) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingAdminV1TransitGatewayAttachmentStatus struct {
	value *NetworkingAdminV1TransitGatewayAttachmentStatus
	isSet bool
}

func (v NullableNetworkingAdminV1TransitGatewayAttachmentStatus) Get() *NetworkingAdminV1TransitGatewayAttachmentStatus {
	return v.value
}

func (v *NullableNetworkingAdminV1TransitGatewayAttachmentStatus) Set(val *NetworkingAdminV1TransitGatewayAttachmentStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingAdminV1TransitGatewayAttachmentStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingAdminV1TransitGatewayAttachmentStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingAdminV1TransitGatewayAttachmentStatus(val *NetworkingAdminV1TransitGatewayAttachmentStatus) *NullableNetworkingAdminV1TransitGatewayAttachmentStatus {
	return &NullableNetworkingAdminV1TransitGatewayAttachmentStatus{value: val, isSet: true}
}

func (v NullableNetworkingAdminV1TransitGatewayAttachmentStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingAdminV1TransitGatewayAttachmentStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
