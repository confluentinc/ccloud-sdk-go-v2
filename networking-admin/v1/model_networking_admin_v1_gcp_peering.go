...
// NetworkingAdminV1GcpPeering GCP VPC Peering.
type NetworkingAdminV1GcpPeering struct {
	// Peering kind type.
...
func NewNetworkingAdminV1GcpPeering(kind string, project string, vpcNetwork string) *NetworkingAdminV1GcpPeering {
	this := NetworkingAdminV1GcpPeering{}
	this.Kind = kind
...
func (o *NetworkingAdminV1GcpPeering) Redact() {
...
func (o *NetworkingAdminV1GcpPeering) recurseRedact(v interface{}) {
...
func (o NetworkingAdminV1GcpPeering) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingAdminV1GcpPeering) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingAdminV1GcpPeering struct {
	value *NetworkingAdminV1GcpPeering
	isSet bool
}

func (v NullableNetworkingAdminV1GcpPeering) Get() *NetworkingAdminV1GcpPeering {
	return v.value
}

func (v *NullableNetworkingAdminV1GcpPeering) Set(val *NetworkingAdminV1GcpPeering) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingAdminV1GcpPeering) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingAdminV1GcpPeering) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingAdminV1GcpPeering(val *NetworkingAdminV1GcpPeering) *NullableNetworkingAdminV1GcpPeering {
	return &NullableNetworkingAdminV1GcpPeering{value: val, isSet: true}
}

func (v NullableNetworkingAdminV1GcpPeering) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingAdminV1GcpPeering) UnmarshalJSON(src []byte) error {
	v.isSet = true
