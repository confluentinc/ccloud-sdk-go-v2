...
type NetworkingAdminV1PrivateLinkAccess struct {
	...
	Spec *NetworkingAdminV1PrivateLinkAccessSpec `json:"spec,omitempty"`
	Status *NetworkingAdminV1PrivateLinkAccessStatus `json:"status,omitempty"`
}
...
func NewNetworkingAdminV1PrivateLinkAccess() *NetworkingAdminV1PrivateLinkAccess {
	this := NetworkingAdminV1PrivateLinkAccess{}
	return &this
}
...
func (o *NetworkingAdminV1PrivateLinkAccess) GetSpec() NetworkingAdminV1PrivateLinkAccessSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingAdminV1PrivateLinkAccessSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given NetworkingAdminV1PrivateLinkAccessSpec and assigns it to the Spec field.
...
func (o *NetworkingAdminV1PrivateLinkAccess) GetStatus() NetworkingAdminV1PrivateLinkAccessStatus {
	if o == nil || o.Status == nil {
		var ret NetworkingAdminV1PrivateLinkAccessStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkingAdminV1PrivateLinkAccessStatus and assigns it to the Status field.
func (o *NetworkingAdminV1PrivateLinkAccess) SetStatus(v NetworkingAdminV1PrivateLinkAccessStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *NetworkingAdminV1PrivateLinkAccess) Redact() {
...
func (o *NetworkingAdminV1PrivateLinkAccess) recurseRedact(v interface{}) {
...
func (o NetworkingAdminV1PrivateLinkAccess) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingAdminV1PrivateLinkAccess) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingAdminV1PrivateLinkAccess struct {
	value *NetworkingAdminV1PrivateLinkAccess
	isSet bool
}

func (v NullableNetworkingAdminV1PrivateLinkAccess) Get() *NetworkingAdminV1PrivateLinkAccess {
	return v.value
}

func (v *NullableNetworkingAdminV1PrivateLinkAccess) Set(val *NetworkingAdminV1PrivateLinkAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingAdminV1PrivateLinkAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingAdminV1PrivateLinkAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingAdminV1PrivateLinkAccess(val *NetworkingAdminV1PrivateLinkAccess) *NullableNetworkingAdminV1PrivateLinkAccess {
	return &NullableNetworkingAdminV1PrivateLinkAccess{value: val, isSet: true}
}

func (v NullableNetworkingAdminV1PrivateLinkAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingAdminV1PrivateLinkAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
