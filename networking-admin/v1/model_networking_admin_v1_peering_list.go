...
type NetworkingAdminV1PeeringList struct {
	...
	Data []NetworkingAdminV1Peering `json:"data"`
}
...
func NewNetworkingAdminV1PeeringList(apiVersion string, kind string, metadata ListMeta, data []NetworkingAdminV1Peering) *NetworkingAdminV1PeeringList {
	this := NetworkingAdminV1PeeringList{}
...
func (o *NetworkingAdminV1PeeringList) GetData() []NetworkingAdminV1Peering {
	if o == nil {
		var ret []NetworkingAdminV1Peering
		return ret
	}
...
func (o *NetworkingAdminV1PeeringList) Redact() {
...
func (o *NetworkingAdminV1PeeringList) recurseRedact(v interface{}) {
...
func (o NetworkingAdminV1PeeringList) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingAdminV1PeeringList) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingAdminV1PeeringList struct {
	value *NetworkingAdminV1PeeringList
	isSet bool
}

func (v NullableNetworkingAdminV1PeeringList) Get() *NetworkingAdminV1PeeringList {
	return v.value
}

func (v *NullableNetworkingAdminV1PeeringList) Set(val *NetworkingAdminV1PeeringList) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingAdminV1PeeringList) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingAdminV1PeeringList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingAdminV1PeeringList(val *NetworkingAdminV1PeeringList) *NullableNetworkingAdminV1PeeringList {
	return &NullableNetworkingAdminV1PeeringList{value: val, isSet: true}
}

func (v NullableNetworkingAdminV1PeeringList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingAdminV1PeeringList) UnmarshalJSON(src []byte) error {
	v.isSet = true
