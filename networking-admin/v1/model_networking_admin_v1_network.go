...
// NetworkingAdminV1Network `Network` represents a network (VPC) in Confluent Cloud. All Networks exist within Confluent-managed cloud provider accounts. Dedicated networks support more networking options but can only contain Dedicated clusters. Shared networks can contain any cluster type.  The API allows you to list, create, read, update, and delete your networks.   Related guide: [APIs to manage networks in Confluent Cloud](https://docs.confluent.io/cloud/current/networking/overview.html).  ## The Networks Model <SchemaDefinition schemaRef=\"#/components/schemas/networking-admin.v1.Network\" />  ## Quotas and Limits This resource is subject to the following quotas:  | Quota | Description | | --- | --- | | `dedicated_networks_per_environment` | Number of dedicated networks per Confluent Cloud environment |
type NetworkingAdminV1Network struct {
	...
	Spec *NetworkingAdminV1NetworkSpec `json:"spec,omitempty"`
	Status *NetworkingAdminV1NetworkStatus `json:"status,omitempty"`
}
...
func (o *NetworkingAdminV1Network) GetSpec() NetworkingAdminV1NetworkSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingAdminV1NetworkSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given NetworkingAdminV1NetworkSpec and assigns it to the Spec field.
...
func (o *NetworkingAdminV1Network) GetStatus() NetworkingAdminV1NetworkStatus {
	if o == nil || o.Status == nil {
		var ret NetworkingAdminV1NetworkStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkingAdminV1NetworkStatus and assigns it to the Status field.
func (o *NetworkingAdminV1Network) SetStatus(v NetworkingAdminV1NetworkStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *NetworkingAdminV1Network) Redact() {
...
func (o *NetworkingAdminV1Network) recurseRedact(v interface{}) {
...
func (o NetworkingAdminV1Network) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingAdminV1Network) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingAdminV1Network struct {
	value *NetworkingAdminV1Network
	isSet bool
}

func (v NullableNetworkingAdminV1Network) Get() *NetworkingAdminV1Network {
	return v.value
}

func (v *NullableNetworkingAdminV1Network) Set(val *NetworkingAdminV1Network) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingAdminV1Network) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingAdminV1Network) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingAdminV1Network(val *NetworkingAdminV1Network) *NullableNetworkingAdminV1Network {
	return &NullableNetworkingAdminV1Network{value: val, isSet: true}
}

func (v NullableNetworkingAdminV1Network) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingAdminV1Network) UnmarshalJSON(src []byte) error {
	v.isSet = true
