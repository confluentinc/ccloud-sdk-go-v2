...
type NetworkingAdminV1Peering struct {
	...
	Spec *NetworkingAdminV1PeeringSpec `json:"spec,omitempty"`
	Status *NetworkingAdminV1PeeringStatus `json:"status,omitempty"`
}
...
func (o *NetworkingAdminV1Peering) GetSpec() NetworkingAdminV1PeeringSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingAdminV1PeeringSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given NetworkingAdminV1PeeringSpec and assigns it to the Spec field.
...
func (o *NetworkingAdminV1Peering) GetStatus() NetworkingAdminV1PeeringStatus {
	if o == nil || o.Status == nil {
		var ret NetworkingAdminV1PeeringStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given NetworkingAdminV1PeeringStatus and assigns it to the Status field.
func (o *NetworkingAdminV1Peering) SetStatus(v NetworkingAdminV1PeeringStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *NetworkingAdminV1Peering) Redact() {
...
func (o *NetworkingAdminV1Peering) recurseRedact(v interface{}) {
...
func (o NetworkingAdminV1Peering) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingAdminV1Peering) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingAdminV1Peering struct {
	value *NetworkingAdminV1Peering
	isSet bool
}

func (v NullableNetworkingAdminV1Peering) Get() *NetworkingAdminV1Peering {
	return v.value
}

func (v *NullableNetworkingAdminV1Peering) Set(val *NetworkingAdminV1Peering) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingAdminV1Peering) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingAdminV1Peering) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingAdminV1Peering(val *NetworkingAdminV1Peering) *NullableNetworkingAdminV1Peering {
	return &NullableNetworkingAdminV1Peering{value: val, isSet: true}
}

func (v NullableNetworkingAdminV1Peering) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingAdminV1Peering) UnmarshalJSON(src []byte) error {
	v.isSet = true
