...
// PartnerV2EntitlementList `Entitlement` objects represent metadata about a marketplace entitlement.
type PartnerV2EntitlementList struct {
	...
	Data []PartnerV2Entitlement `json:"data"`
}
...
func (o PartnerV2EntitlementList) MarshalJSON() ([]byte, error) {
...
type NullablePartnerV2EntitlementList struct {
	value *PartnerV2EntitlementList
	isSet bool
}

func (v NullablePartnerV2EntitlementList) Get() *PartnerV2EntitlementList {
	return v.value
}

func (v *NullablePartnerV2EntitlementList) Set(val *PartnerV2EntitlementList) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerV2EntitlementList) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerV2EntitlementList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerV2EntitlementList(val *PartnerV2EntitlementList) *NullablePartnerV2EntitlementList {
	return &NullablePartnerV2EntitlementList{value: val, isSet: true}
}

func (v NullablePartnerV2EntitlementList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerV2EntitlementList) UnmarshalJSON(src []byte) error {
	v.isSet = true
