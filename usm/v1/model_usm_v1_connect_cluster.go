...
// UsmV1ConnectCluster `ConnectCluster` object represent Confluent Platform Connect clusters registered with Confluent Cloud. The API allows you to create and delete ConnectCluster.   ## The Connect Clusters Model <SchemaDefinition schemaRef=\"#/components/schemas/usm.v1.ConnectCluster\" />
...
// GetConfluentPlatformConnectClusterId returns the ConfluentPlatformConnectClusterId field value if set, zero value otherwise.
func (o *UsmV1ConnectCluster) GetConfluentPlatformConnectClusterId() string {
	if o == nil || o.ConfluentPlatformConnectClusterId == nil {
		var ret string
		return ret
	}
	return *o.ConfluentPlatformConnectClusterId
}

// GetConfluentPlatformConnectClusterIdOk returns a tuple with the ConfluentPlatformConnectClusterId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UsmV1ConnectCluster) GetConfluentPlatformConnectClusterIdOk() (*string, bool) {
	if o == nil || o.ConfluentPlatformConnectClusterId == nil {
		return nil, false
	}
	return o.ConfluentPlatformConnectClusterId, true
}
...
// SetConfluentPlatformConnectClusterId gets a reference to the given string and assigns it to the ConfluentPlatformConnectClusterId field.
func (o *UsmV1ConnectCluster) SetConfluentPlatformConnectClusterId(v string) {
	o.ConfluentPlatformConnectClusterId = &v
}
...
func (o *UsmV1ConnectCluster) Redact() {
...
func (o *UsmV1ConnectCluster) recurseRedact(v interface{}) {
...
func (o UsmV1ConnectCluster) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o UsmV1ConnectCluster) MarshalJSON() ([]byte, error) {
	...
	if o.ConfluentPlatformConnectClusterId != nil {
		toSerialize["confluent_platform_connect_cluster_id"] = o.ConfluentPlatformConnectClusterId
	}
...
type NullableUsmV1ConnectCluster struct {
	value *UsmV1ConnectCluster
	isSet bool
}

func (v NullableUsmV1ConnectCluster) Get() *UsmV1ConnectCluster {
	return v.value
}

func (v *NullableUsmV1ConnectCluster) Set(val *UsmV1ConnectCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableUsmV1ConnectCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableUsmV1ConnectCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsmV1ConnectCluster(val *UsmV1ConnectCluster) *NullableUsmV1ConnectCluster {
	return &NullableUsmV1ConnectCluster{value: val, isSet: true}
}

func (v NullableUsmV1ConnectCluster) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableUsmV1ConnectCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
