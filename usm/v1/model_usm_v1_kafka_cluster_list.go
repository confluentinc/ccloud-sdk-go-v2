...
// UsmV1KafkaClusterList `KafkaCluster` object represent Confluent Platform Kafka clusters registered with Confluent Cloud. The API allows you to create and delete KafkaCluster.   ## The Kafka Clusters Model <SchemaDefinition schemaRef=\"#/components/schemas/usm.v1.KafkaCluster\" />
type UsmV1KafkaClusterList struct {
	...
	Data []UsmV1KafkaCluster `json:"data,omitempty"`
}
...
func (o *UsmV1KafkaClusterList) Redact() {
...
func (o *UsmV1KafkaClusterList) recurseRedact(v interface{}) {
...
func (o UsmV1KafkaClusterList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o UsmV1KafkaClusterList) MarshalJSON() ([]byte, error) {
...
type NullableUsmV1KafkaClusterList struct {
	value *UsmV1KafkaClusterList
	isSet bool
}

func (v NullableUsmV1KafkaClusterList) Get() *UsmV1KafkaClusterList {
	return v.value
}

func (v *NullableUsmV1KafkaClusterList) Set(val *UsmV1KafkaClusterList) {
	v.value = val
	v.isSet = true
}

func (v NullableUsmV1KafkaClusterList) IsSet() bool {
	return v.isSet
}

func (v *NullableUsmV1KafkaClusterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUsmV1KafkaClusterList(val *UsmV1KafkaClusterList) *NullableUsmV1KafkaClusterList {
	return &NullableUsmV1KafkaClusterList{value: val, isSet: true}
}

func (v NullableUsmV1KafkaClusterList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableUsmV1KafkaClusterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
