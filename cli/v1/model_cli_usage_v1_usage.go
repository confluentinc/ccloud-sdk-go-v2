...
// CliUsageV1Usage `Usage` objects represent CLI commands that were run while logged in to Confluent Cloud. The API creates usage objects that are collected for CLI analytics.   ## The Usages Model <SchemaDefinition schemaRef=\"#/components/schemas/cli-usage.v1.Usage\" />
type CliUsageV1Usage struct {
...
func (o *CliUsageV1Usage) recurseRedact(v interface{}) {
...
func (o CliUsageV1Usage) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o CliUsageV1Usage) MarshalJSON() ([]byte, error) {
...
type NullableCliUsageV1Usage struct {
	value *CliUsageV1Usage
	isSet bool
}

func (v NullableCliUsageV1Usage) Get() *CliUsageV1Usage {
	return v.value
}

func (v *NullableCliUsageV1Usage) Set(val *CliUsageV1Usage) {
	v.value = val
	v.isSet = true
}

func (v NullableCliUsageV1Usage) IsSet() bool {
	return v.isSet
}

func (v *NullableCliUsageV1Usage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCliUsageV1Usage(val *CliUsageV1Usage) *NullableCliUsageV1Usage {
	return &NullableCliUsageV1Usage{value: val, isSet: true}
}

func (v NullableCliUsageV1Usage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCliUsageV1Usage) UnmarshalJSON(src []byte) error {
	v.isSet = true
