...
func NewServiceQuotaV2AppliedQuota() *ServiceQuotaV2AppliedQuota {
	this := ServiceQuotaV2AppliedQuota{}
	return &this
}
...
func (o *ServiceQuotaV2AppliedQuota) Redact() {
...
func (o *ServiceQuotaV2AppliedQuota) recurseRedact(v interface{}) {
...
func (o ServiceQuotaV2AppliedQuota) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o ServiceQuotaV2AppliedQuota) MarshalJSON() ([]byte, error) {
...
type NullableServiceQuotaV2AppliedQuota struct {
	value *ServiceQuotaV2AppliedQuota
	isSet bool
}

func (v NullableServiceQuotaV2AppliedQuota) Get() *ServiceQuotaV2AppliedQuota {
	return v.value
}

func (v *NullableServiceQuotaV2AppliedQuota) Set(val *ServiceQuotaV2AppliedQuota) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV2AppliedQuota) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV2AppliedQuota) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV2AppliedQuota(val *ServiceQuotaV2AppliedQuota) *NullableServiceQuotaV2AppliedQuota {
	return &NullableServiceQuotaV2AppliedQuota{value: val, isSet: true}
}

func (v NullableServiceQuotaV2AppliedQuota) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV2AppliedQuota) UnmarshalJSON(src []byte) error {
	v.isSet = true
