...
// ServiceQuotaV2Scope Gets a list of all available scopes for applied quotas.   Related guide: [Quota Scopes](https://docs.confluent.io/cloud/current/quotas/quotas.html#query-for-scopes).  ## The Scopes Model <SchemaDefinition schemaRef=\"#/components/schemas/service-quota.v2.Scope\" />
type ServiceQuotaV2Scope struct {
...
func (o *ServiceQuotaV2Scope) Redact() {
...
func (o *ServiceQuotaV2Scope) recurseRedact(v interface{}) {
...
func (o ServiceQuotaV2Scope) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o ServiceQuotaV2Scope) MarshalJSON() ([]byte, error) {
...
type NullableServiceQuotaV2Scope struct {
	value *ServiceQuotaV2Scope
	isSet bool
}

func (v NullableServiceQuotaV2Scope) Get() *ServiceQuotaV2Scope {
	return v.value
}

func (v *NullableServiceQuotaV2Scope) Set(val *ServiceQuotaV2Scope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV2Scope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV2Scope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV2Scope(val *ServiceQuotaV2Scope) *NullableServiceQuotaV2Scope {
	return &NullableServiceQuotaV2Scope{value: val, isSet: true}
}

func (v NullableServiceQuotaV2Scope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV2Scope) UnmarshalJSON(src []byte) error {
	v.isSet = true
