...
// Source: ./service-quota/v1/api_scopes_service_quota_v1.go
...
type MockScopesServiceQuotaV1Api struct {
	...
	GetServiceQuotaV1ScopeFunc func(ctx context.Context, id string) command_line_arguments.ApiGetServiceQuotaV1ScopeRequest

	lockGetServiceQuotaV1ScopeExecute sync.Mutex
	GetServiceQuotaV1ScopeExecuteFunc func(r command_line_arguments.ApiGetServiceQuotaV1ScopeRequest) (command_line_arguments.ServiceQuotaV1Scope, *net_http.Response, error)

	lockListServiceQuotaV1Scopes sync.Mutex
	ListServiceQuotaV1ScopesFunc func(ctx context.Context) command_line_arguments.ApiListServiceQuotaV1ScopesRequest

	lockListServiceQuotaV1ScopesExecute sync.Mutex
	ListServiceQuotaV1ScopesExecuteFunc func(r command_line_arguments.ApiListServiceQuotaV1ScopesRequest) (command_line_arguments.ServiceQuotaV1ScopeList, *net_http.Response, error)
	...
	calls struct {
		...
		GetServiceQuotaV1ScopeExecute []struct {
			R command_line_arguments.ApiGetServiceQuotaV1ScopeRequest
		}
		ListServiceQuotaV1Scopes []struct {
			Ctx context.Context
		}
		ListServiceQuotaV1ScopesExecute []struct {
			R command_line_arguments.ApiListServiceQuotaV1ScopesRequest
		}
	}
}

// GetServiceQuotaV1Scope mocks base method by wrapping the associated func.
func (m *MockScopesServiceQuotaV1Api) GetServiceQuotaV1Scope(ctx context.Context, id string) command_line_arguments.ApiGetServiceQuotaV1ScopeRequest {
...
func (m *MockScopesServiceQuotaV1Api) GetServiceQuotaV1ScopeExecute(r command_line_arguments.ApiGetServiceQuotaV1ScopeRequest) (command_line_arguments.ServiceQuotaV1Scope, *net_http.Response, error) {
...
func (m *MockScopesServiceQuotaV1Api) ListServiceQuotaV1Scopes(ctx context.Context) command_line_arguments.ApiListServiceQuotaV1ScopesRequest {
...
func (m *MockScopesServiceQuotaV1Api) ListServiceQuotaV1ScopesExecute(r command_line_arguments.ApiListServiceQuotaV1ScopesRequest) (command_line_arguments.ServiceQuotaV1ScopeList, *net_http.Response, error) {
