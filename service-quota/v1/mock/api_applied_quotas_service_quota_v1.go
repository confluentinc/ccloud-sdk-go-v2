...
// Source: ./service-quota/v1/api_applied_quotas_service_quota_v1.go
...
type MockAppliedQuotasServiceQuotaV1Api struct {
	...
	GetServiceQuotaV1AppliedQuotaFunc func(ctx context.Context, id string) command_line_arguments.ApiGetServiceQuotaV1AppliedQuotaRequest

	lockGetServiceQuotaV1AppliedQuotaExecute sync.Mutex
	GetServiceQuotaV1AppliedQuotaExecuteFunc func(r command_line_arguments.ApiGetServiceQuotaV1AppliedQuotaRequest) (command_line_arguments.ServiceQuotaV1AppliedQuota, *net_http.Response, error)

	lockListServiceQuotaV1AppliedQuotas sync.Mutex
	ListServiceQuotaV1AppliedQuotasFunc func(ctx context.Context) command_line_arguments.ApiListServiceQuotaV1AppliedQuotasRequest

	lockListServiceQuotaV1AppliedQuotasExecute sync.Mutex
	ListServiceQuotaV1AppliedQuotasExecuteFunc func(r command_line_arguments.ApiListServiceQuotaV1AppliedQuotasRequest) (command_line_arguments.ServiceQuotaV1AppliedQuotaList, *net_http.Response, error)
	...
	calls struct {
		...
		GetServiceQuotaV1AppliedQuotaExecute []struct {
			R command_line_arguments.ApiGetServiceQuotaV1AppliedQuotaRequest
		}
		ListServiceQuotaV1AppliedQuotas []struct {
			Ctx context.Context
		}
		ListServiceQuotaV1AppliedQuotasExecute []struct {
			R command_line_arguments.ApiListServiceQuotaV1AppliedQuotasRequest
		}
	}
}

// GetServiceQuotaV1AppliedQuota mocks base method by wrapping the associated func.
func (m *MockAppliedQuotasServiceQuotaV1Api) GetServiceQuotaV1AppliedQuota(ctx context.Context, id string) command_line_arguments.ApiGetServiceQuotaV1AppliedQuotaRequest {
...
func (m *MockAppliedQuotasServiceQuotaV1Api) GetServiceQuotaV1AppliedQuotaExecute(r command_line_arguments.ApiGetServiceQuotaV1AppliedQuotaRequest) (command_line_arguments.ServiceQuotaV1AppliedQuota, *net_http.Response, error) {
...
func (m *MockAppliedQuotasServiceQuotaV1Api) ListServiceQuotaV1AppliedQuotas(ctx context.Context) command_line_arguments.ApiListServiceQuotaV1AppliedQuotasRequest {
...
func (m *MockAppliedQuotasServiceQuotaV1Api) ListServiceQuotaV1AppliedQuotasExecute(r command_line_arguments.ApiListServiceQuotaV1AppliedQuotasRequest) (command_line_arguments.ServiceQuotaV1AppliedQuotaList, *net_http.Response, error) {
