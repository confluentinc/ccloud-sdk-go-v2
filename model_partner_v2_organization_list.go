...
// PartnerV2OrganizationList `Organizations` objects represent an entire Confluent Cloud organization.
type PartnerV2OrganizationList struct {
	...
	Data     []PartnerV2Organization `json:"data"`
}
...
func NewPartnerV2OrganizationList(apiVersion string, kind string, metadata ListMeta, data []PartnerV2Organization) *PartnerV2OrganizationList {
	this := PartnerV2OrganizationList{}
...
func (o PartnerV2OrganizationList) MarshalJSON() ([]byte, error) {
...
type NullablePartnerV2OrganizationList struct {
	value *PartnerV2OrganizationList
	isSet bool
}

func (v NullablePartnerV2OrganizationList) Get() *PartnerV2OrganizationList {
	return v.value
}

func (v *NullablePartnerV2OrganizationList) Set(val *PartnerV2OrganizationList) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerV2OrganizationList) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerV2OrganizationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerV2OrganizationList(val *PartnerV2OrganizationList) *NullablePartnerV2OrganizationList {
	return &NullablePartnerV2OrganizationList{value: val, isSet: true}
}

func (v NullablePartnerV2OrganizationList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerV2OrganizationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
