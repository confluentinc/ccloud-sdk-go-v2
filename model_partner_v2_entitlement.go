...
// PartnerV2Entitlement `Entitlement` objects represent metadata about a marketplace entitlement.
...
func (o *PartnerV2Entitlement) GetUsageReportingId() string {
	if o == nil || o.UsageReportingId == nil {
		var ret string
		return ret
	}
...
func (o PartnerV2Entitlement) MarshalJSON() ([]byte, error) {
	...
	if o.UsageReportingId != nil {
		toSerialize["usage_reporting_id"] = o.UsageReportingId
	}
	if o.ResourceId != nil {
...
type NullablePartnerV2Entitlement struct {
	value *PartnerV2Entitlement
	isSet bool
}

func (v NullablePartnerV2Entitlement) Get() *PartnerV2Entitlement {
	return v.value
}

func (v *NullablePartnerV2Entitlement) Set(val *PartnerV2Entitlement) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerV2Entitlement) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerV2Entitlement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerV2Entitlement(val *PartnerV2Entitlement) *NullablePartnerV2Entitlement {
	return &NullablePartnerV2Entitlement{value: val, isSet: true}
}

func (v NullablePartnerV2Entitlement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerV2Entitlement) UnmarshalJSON(src []byte) error {
	v.isSet = true
