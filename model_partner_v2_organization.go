...
// PartnerV2Organization `Organizations` objects represent an entire Confluent Cloud organization.
type PartnerV2Organization struct {
	...
	SsoConfig *PartnerV2OrganizationSsoConfigOneOf `json:"sso_config,omitempty"`
}
...
// GetSsoConfig returns the SsoConfig field value if set, zero value otherwise.
func (o *PartnerV2Organization) GetSsoConfig() PartnerV2OrganizationSsoConfigOneOf {
	if o == nil || o.SsoConfig == nil {
		var ret PartnerV2OrganizationSsoConfigOneOf
		return ret
	}
	return *o.SsoConfig
}

// GetSsoConfigOk returns a tuple with the SsoConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PartnerV2Organization) GetSsoConfigOk() (*PartnerV2OrganizationSsoConfigOneOf, bool) {
	if o == nil || o.SsoConfig == nil {
		return nil, false
	}
	return o.SsoConfig, true
}
...
// SetSsoConfig gets a reference to the given PartnerV2OrganizationSsoConfigOneOf and assigns it to the SsoConfig field.
func (o *PartnerV2Organization) SetSsoConfig(v PartnerV2OrganizationSsoConfigOneOf) {
	o.SsoConfig = &v
}

func (o PartnerV2Organization) MarshalJSON() ([]byte, error) {
	...
	if o.SsoConfig != nil {
		toSerialize["sso_config"] = o.SsoConfig
	}
	return json.Marshal(toSerialize)
}

type NullablePartnerV2Organization struct {
	value *PartnerV2Organization
	isSet bool
}

func (v NullablePartnerV2Organization) Get() *PartnerV2Organization {
	return v.value
}

func (v *NullablePartnerV2Organization) Set(val *PartnerV2Organization) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerV2Organization) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerV2Organization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerV2Organization(val *PartnerV2Organization) *NullablePartnerV2Organization {
	return &NullablePartnerV2Organization{value: val, isSet: true}
}

func (v NullablePartnerV2Organization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerV2Organization) UnmarshalJSON(src []byte) error {
	v.isSet = true
