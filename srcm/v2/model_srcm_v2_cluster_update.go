...
func (o *SrcmV2ClusterUpdate) GetSpec() SrcmV2ClusterSpecUpdate {
	if o == nil || o.Spec == nil {
		var ret SrcmV2ClusterSpecUpdate
		return ret
	}
	return *o.Spec
}
...
func (o *SrcmV2ClusterUpdate) recurseRedact(v interface{}) {
...
func (o SrcmV2ClusterUpdate) zeroField(v interface{}) {
...
type NullableSrcmV2ClusterUpdate struct {
	value *SrcmV2ClusterUpdate
	isSet bool
}

func (v NullableSrcmV2ClusterUpdate) Get() *SrcmV2ClusterUpdate {
	return v.value
}

func (v *NullableSrcmV2ClusterUpdate) Set(val *SrcmV2ClusterUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2ClusterUpdate) IsSet() bool {
	return v.isSet
}
...
func NewNullableSrcmV2ClusterUpdate(val *SrcmV2ClusterUpdate) *NullableSrcmV2ClusterUpdate {
	return &NullableSrcmV2ClusterUpdate{value: val, isSet: true}
}
