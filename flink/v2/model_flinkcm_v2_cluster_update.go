...
type FlinkcmV2ClusterUpdate struct {
	...
	Spec *FlinkcmV2ClusterSpecUpdate `json:"spec,omitempty"`
	Status *FlinkcmV2ClusterStatus `json:"status,omitempty"`
}
...
func (o *FlinkcmV2ClusterUpdate) GetSpec() FlinkcmV2ClusterSpecUpdate {
	if o == nil || o.Spec == nil {
		var ret FlinkcmV2ClusterSpecUpdate
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given FlinkcmV2ClusterSpecUpdate and assigns it to the Spec field.
...
func (o *FlinkcmV2ClusterUpdate) GetStatus() FlinkcmV2ClusterStatus {
	if o == nil || o.Status == nil {
		var ret FlinkcmV2ClusterStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given FlinkcmV2ClusterStatus and assigns it to the Status field.
func (o *FlinkcmV2ClusterUpdate) SetStatus(v FlinkcmV2ClusterStatus) {
	o.Status = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *FlinkcmV2ClusterUpdate) Redact() {
...
func (o *FlinkcmV2ClusterUpdate) recurseRedact(v interface{}) {
...
func (o FlinkcmV2ClusterUpdate) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o FlinkcmV2ClusterUpdate) MarshalJSON() ([]byte, error) {
...
type NullableFlinkcmV2ClusterUpdate struct {
	value *FlinkcmV2ClusterUpdate
	isSet bool
}

func (v NullableFlinkcmV2ClusterUpdate) Get() *FlinkcmV2ClusterUpdate {
	return v.value
}

func (v *NullableFlinkcmV2ClusterUpdate) Set(val *FlinkcmV2ClusterUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableFlinkcmV2ClusterUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableFlinkcmV2ClusterUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlinkcmV2ClusterUpdate(val *FlinkcmV2ClusterUpdate) *NullableFlinkcmV2ClusterUpdate {
	return &NullableFlinkcmV2ClusterUpdate{value: val, isSet: true}
}

func (v NullableFlinkcmV2ClusterUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlinkcmV2ClusterUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
