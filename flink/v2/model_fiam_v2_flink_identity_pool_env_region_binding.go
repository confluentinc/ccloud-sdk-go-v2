...
type FiamV2FlinkIdentityPoolEnvRegionBinding struct {
	...
	// Flink compute pools in the region provider will be able to use this identity pool.
...
func NewFiamV2FlinkIdentityPoolEnvRegionBinding() *FiamV2FlinkIdentityPoolEnvRegionBinding {
	this := FiamV2FlinkIdentityPoolEnvRegionBinding{}
	return &this
}
...
func (o *FiamV2FlinkIdentityPoolEnvRegionBinding) Redact() {
...
func (o *FiamV2FlinkIdentityPoolEnvRegionBinding) recurseRedact(v interface{}) {
...
func (o FiamV2FlinkIdentityPoolEnvRegionBinding) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o FiamV2FlinkIdentityPoolEnvRegionBinding) MarshalJSON() ([]byte, error) {
...
type NullableFiamV2FlinkIdentityPoolEnvRegionBinding struct {
	value *FiamV2FlinkIdentityPoolEnvRegionBinding
	isSet bool
}

func (v NullableFiamV2FlinkIdentityPoolEnvRegionBinding) Get() *FiamV2FlinkIdentityPoolEnvRegionBinding {
	return v.value
}

func (v *NullableFiamV2FlinkIdentityPoolEnvRegionBinding) Set(val *FiamV2FlinkIdentityPoolEnvRegionBinding) {
	v.value = val
	v.isSet = true
}

func (v NullableFiamV2FlinkIdentityPoolEnvRegionBinding) IsSet() bool {
	return v.isSet
}

func (v *NullableFiamV2FlinkIdentityPoolEnvRegionBinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiamV2FlinkIdentityPoolEnvRegionBinding(val *FiamV2FlinkIdentityPoolEnvRegionBinding) *NullableFiamV2FlinkIdentityPoolEnvRegionBinding {
	return &NullableFiamV2FlinkIdentityPoolEnvRegionBinding{value: val, isSet: true}
}

func (v NullableFiamV2FlinkIdentityPoolEnvRegionBinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiamV2FlinkIdentityPoolEnvRegionBinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
