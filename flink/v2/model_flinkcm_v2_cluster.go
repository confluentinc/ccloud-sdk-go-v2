...
type FlinkcmV2Cluster struct {
	...
	Spec *FlinkcmV2ClusterSpec `json:"spec,omitempty"`
...
// SetSpec gets a reference to the given FlinkcmV2ClusterSpec and assigns it to the Spec field.
...
func (o *FlinkcmV2Cluster) Redact() {
...
func (o *FlinkcmV2Cluster) recurseRedact(v interface{}) {
...
func (o FlinkcmV2Cluster) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o FlinkcmV2Cluster) MarshalJSON() ([]byte, error) {
...
type NullableFlinkcmV2Cluster struct {
	value *FlinkcmV2Cluster
	isSet bool
}

func (v NullableFlinkcmV2Cluster) Get() *FlinkcmV2Cluster {
	return v.value
}

func (v *NullableFlinkcmV2Cluster) Set(val *FlinkcmV2Cluster) {
	v.value = val
	v.isSet = true
}

func (v NullableFlinkcmV2Cluster) IsSet() bool {
	return v.isSet
}

func (v *NullableFlinkcmV2Cluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlinkcmV2Cluster(val *FlinkcmV2Cluster) *NullableFlinkcmV2Cluster {
	return &NullableFlinkcmV2Cluster{value: val, isSet: true}
}

func (v NullableFlinkcmV2Cluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlinkcmV2Cluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
