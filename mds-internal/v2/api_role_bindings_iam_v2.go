...
// Filter the results by exact match for exclude_principals.
func (r ApiListIamV2RoleBindingsRequest) ExcludePrincipals(excludePrincipals string) ApiListIamV2RoleBindingsRequest {
	r.excludePrincipals = &excludePrincipals
	return r
}
...
func (a *RoleBindingsIamV2ApiService) ListIamV2RoleBindingsExecute(r ApiListIamV2RoleBindingsRequest) (IamV2RoleBindingList, *_nethttp.Response, error) {
	...
	if r.excludePrincipals == nil {
		return localVarReturnValue, nil, reportError("excludePrincipals is required and must be specified")
	}
	...
	localVarQueryParams.Add("exclude_principals", parameterToString(*r.excludePrincipals, ""))
	if r.pageSize != nil {
