...
type IamV2RoleBinding struct {
	...
	// A list of principals whose role bindings will be excluded. Used to filter out ISA role bindings.
...
// GetExcludePrincipals returns the ExcludePrincipals field value if set, zero value otherwise.
func (o *IamV2RoleBinding) GetExcludePrincipals() []string {
	if o == nil || o.ExcludePrincipals == nil {
		var ret []string
		return ret
	}
	return *o.ExcludePrincipals
}

// GetExcludePrincipalsOk returns a tuple with the ExcludePrincipals field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IamV2RoleBinding) GetExcludePrincipalsOk() (*[]string, bool) {
	if o == nil || o.ExcludePrincipals == nil {
		return nil, false
	}
	return o.ExcludePrincipals, true
}
...
// SetExcludePrincipals gets a reference to the given []string and assigns it to the ExcludePrincipals field.
func (o *IamV2RoleBinding) SetExcludePrincipals(v []string) {
	o.ExcludePrincipals = &v
}
...
func (o *IamV2RoleBinding) Redact() {
    ...
    o.recurseRedact(o.ExcludePrincipals)
}
...
func (o IamV2RoleBinding) MarshalJSON() ([]byte, error) {
	...
	if o.ExcludePrincipals != nil {
		toSerialize["exclude_principals"] = o.ExcludePrincipals
	}
