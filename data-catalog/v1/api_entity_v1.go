...
type EntityV1Api interface {
	...
	*/
	...
	/*
		RepublishAllEntities Republish all entities events.

		Republish all entities events.

		 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		 @return ApiRepublishAllEntitiesRequest
	*/
	RepublishAllEntities(ctx _context.Context) ApiRepublishAllEntitiesRequest

	// RepublishAllEntitiesExecute executes the request
	RepublishAllEntitiesExecute(r ApiRepublishAllEntitiesRequest) (*_nethttp.Response, error)
...
type ApiRepublishAllEntitiesRequest struct {
	ctx        _context.Context
	ApiService EntityV1Api
}

func (r ApiRepublishAllEntitiesRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.RepublishAllEntitiesExecute(r)
}
...
Republish all entities events.
 ...
 @return ApiRepublishAllEntitiesRequest
*/
func (a *EntityV1ApiService) RepublishAllEntities(ctx _context.Context) ApiRepublishAllEntitiesRequest {
	return ApiRepublishAllEntitiesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *EntityV1ApiService) RepublishAllEntitiesExecute(r ApiRepublishAllEntitiesRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EntityV1ApiService.RepublishAllEntities")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/catalog/v1/entity-notifications-snapshot"
