...
// Filter the results by exact match for deactivated.
func (r ApiListIamV2IdentityProvidersRequest) Deactivated(deactivated string) ApiListIamV2IdentityProvidersRequest {
...
func (a *IdentityProvidersIamV2ApiService) ListIamV2IdentityProvidersExecute(r ApiListIamV2IdentityProvidersRequest) (IamV2IdentityProviderList, *_nethttp.Response, error) {
	...
	if r.deactivated != nil {
		localVarQueryParams.Add("deactivated", parameterToString(*r.deactivated, ""))
	}
	if r.pageSize != nil {
