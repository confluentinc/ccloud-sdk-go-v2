...
func NewBrokerConfigDataListAllOf(data []BrokerConfigData) *BrokerConfigDataListAllOf {
	this := BrokerConfigDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *BrokerConfigDataListAllOf) recurseRedact(v interface{}) {
...
func (o BrokerConfigDataListAllOf) zeroField(v interface{}) {
...
type NullableBrokerConfigDataListAllOf struct {
	value *BrokerConfigDataListAllOf
	isSet bool
}

func (v NullableBrokerConfigDataListAllOf) Get() *BrokerConfigDataListAllOf {
	return v.value
}

func (v *NullableBrokerConfigDataListAllOf) Set(val *BrokerConfigDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBrokerConfigDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBrokerConfigDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrokerConfigDataListAllOf(val *BrokerConfigDataListAllOf) *NullableBrokerConfigDataListAllOf {
	return &NullableBrokerConfigDataListAllOf{value: val, isSet: true}
}
