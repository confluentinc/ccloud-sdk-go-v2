...
func (o *ClusterConfigDataList) recurseRedact(v interface{}) {
...
func (o ClusterConfigDataList) zeroField(v interface{}) {
...
func (v NullableClusterConfigDataList) Get() *ClusterConfigDataList {
	return v.value
}

func (v *NullableClusterConfigDataList) Set(val *ClusterConfigDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterConfigDataList) IsSet() bool {
	return v.isSet
}
...
func NewNullableClusterConfigDataList(val *ClusterConfigDataList) *NullableClusterConfigDataList {
	return &NullableClusterConfigDataList{value: val, isSet: true}
}
