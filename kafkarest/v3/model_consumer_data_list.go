...
func (o *ConsumerDataList) recurseRedact(v interface{}) {
...
func (o ConsumerDataList) zeroField(v interface{}) {
...
type NullableConsumerDataList struct {
	value *ConsumerDataList
	isSet bool
}

func (v NullableConsumerDataList) Get() *ConsumerDataList {
	return v.value
}

func (v *NullableConsumerDataList) Set(val *ConsumerDataList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableConsumerDataList(val *ConsumerDataList) *NullableConsumerDataList {
	return &NullableConsumerDataList{value: val, isSet: true}
}
