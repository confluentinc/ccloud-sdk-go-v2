...
// ShareGroupConsumerDataList struct for ShareGroupConsumerDataList
...
func NewShareGroupConsumerDataList(kind string, metadata ResourceCollectionMetadata, data []ShareGroupConsumerData) *ShareGroupConsumerDataList {
	this := ShareGroupConsumerDataList{}
	this.Kind = kind
...
func (o *ShareGroupConsumerDataList) Redact() {
	o.recurseRedact(&o.Kind)
	o.recurseRedact(&o.Metadata)
	o.recurseRedact(&o.Data)
}

func (o *ShareGroupConsumerDataList) recurseRedact(v interface{}) {
...
func (o ShareGroupConsumerDataList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o ShareGroupConsumerDataList) MarshalJSON() ([]byte, error) {
...
type NullableShareGroupConsumerDataList struct {
	value *ShareGroupConsumerDataList
	isSet bool
}

func (v NullableShareGroupConsumerDataList) Get() *ShareGroupConsumerDataList {
	return v.value
}

func (v *NullableShareGroupConsumerDataList) Set(val *ShareGroupConsumerDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableShareGroupConsumerDataList) IsSet() bool {
	return v.isSet
}

func (v *NullableShareGroupConsumerDataList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareGroupConsumerDataList(val *ShareGroupConsumerDataList) *NullableShareGroupConsumerDataList {
	return &NullableShareGroupConsumerDataList{value: val, isSet: true}
}

func (v NullableShareGroupConsumerDataList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableShareGroupConsumerDataList) UnmarshalJSON(src []byte) error {
	v.isSet = true
