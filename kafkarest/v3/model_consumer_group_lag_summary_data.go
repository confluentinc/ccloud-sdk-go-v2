...
func NewConsumerGroupLagSummaryData(kind string, metadata ResourceMetadata, clusterId string, consumerGroupId string, maxLagConsumerId string, maxLagClientId string, maxLagTopicName string, maxLagPartitionId int32, maxLag int64, totalLag int64, maxLagConsumer Relationship, maxLagPartition Relationship) *ConsumerGroupLagSummaryData {
	this := ConsumerGroupLagSummaryData{}
	this.Kind = kind
...
type NullableConsumerGroupLagSummaryData struct {
	value *ConsumerGroupLagSummaryData
	isSet bool
}

func (v NullableConsumerGroupLagSummaryData) Get() *ConsumerGroupLagSummaryData {
	return v.value
}

func (v *NullableConsumerGroupLagSummaryData) Set(val *ConsumerGroupLagSummaryData) {
	v.value = val
	v.isSet = true
}

func (v NullableConsumerGroupLagSummaryData) IsSet() bool {
	return v.isSet
}

func (v *NullableConsumerGroupLagSummaryData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConsumerGroupLagSummaryData(val *ConsumerGroupLagSummaryData) *NullableConsumerGroupLagSummaryData {
	return &NullableConsumerGroupLagSummaryData{value: val, isSet: true}
}
