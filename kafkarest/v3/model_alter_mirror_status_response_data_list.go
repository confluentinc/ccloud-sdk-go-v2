...
func NewAlterMirrorStatusResponseDataList(kind string, metadata ResourceCollectionMetadata, data []AlterMirrorStatusResponseData) *AlterMirrorStatusResponseDataList {
	this := AlterMirrorStatusResponseDataList{}
	this.Kind = kind
...
type NullableAlterMirrorStatusResponseDataList struct {
	value *AlterMirrorStatusResponseDataList
	isSet bool
}

func (v NullableAlterMirrorStatusResponseDataList) Get() *AlterMirrorStatusResponseDataList {
	return v.value
}

func (v *NullableAlterMirrorStatusResponseDataList) Set(val *AlterMirrorStatusResponseDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableAlterMirrorStatusResponseDataList) IsSet() bool {
	return v.isSet
}

func (v *NullableAlterMirrorStatusResponseDataList) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableAlterMirrorStatusResponseDataList(val *AlterMirrorStatusResponseDataList) *NullableAlterMirrorStatusResponseDataList {
	return &NullableAlterMirrorStatusResponseDataList{value: val, isSet: true}
}

func (v NullableAlterMirrorStatusResponseDataList) MarshalJSON() ([]byte, error) {
