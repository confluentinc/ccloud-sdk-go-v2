...
func (o *ConsumerDataListAllOf) recurseRedact(v interface{}) {
...
func (o ConsumerDataListAllOf) zeroField(v interface{}) {
...
type NullableConsumerDataListAllOf struct {
	value *ConsumerDataListAllOf
	isSet bool
}

func (v NullableConsumerDataListAllOf) Get() *ConsumerDataListAllOf {
	return v.value
}

func (v *NullableConsumerDataListAllOf) Set(val *ConsumerDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableConsumerDataListAllOf) IsSet() bool {
	return v.isSet
}
...
func NewNullableConsumerDataListAllOf(val *ConsumerDataListAllOf) *NullableConsumerDataListAllOf {
	return &NullableConsumerDataListAllOf{value: val, isSet: true}
}
