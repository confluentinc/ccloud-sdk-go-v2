...
func (o *ReplicaStatusDataList) recurseRedact(v interface{}) {
...
func (o ReplicaStatusDataList) zeroField(v interface{}) {
...
type NullableReplicaStatusDataList struct {
	value *ReplicaStatusDataList
	isSet bool
}

func (v NullableReplicaStatusDataList) Get() *ReplicaStatusDataList {
	return v.value
}

func (v *NullableReplicaStatusDataList) Set(val *ReplicaStatusDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableReplicaStatusDataList) IsSet() bool {
	return v.isSet
}
...
func NewNullableReplicaStatusDataList(val *ReplicaStatusDataList) *NullableReplicaStatusDataList {
	return &NullableReplicaStatusDataList{value: val, isSet: true}
}
