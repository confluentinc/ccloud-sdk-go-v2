...
type NullableAlterMirrorStatusResponseData struct {
	value *AlterMirrorStatusResponseData
	isSet bool
}

func (v NullableAlterMirrorStatusResponseData) Get() *AlterMirrorStatusResponseData {
	return v.value
}

func (v *NullableAlterMirrorStatusResponseData) Set(val *AlterMirrorStatusResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableAlterMirrorStatusResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableAlterMirrorStatusResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlterMirrorStatusResponseData(val *AlterMirrorStatusResponseData) *NullableAlterMirrorStatusResponseData {
	return &NullableAlterMirrorStatusResponseData{value: val, isSet: true}
}
