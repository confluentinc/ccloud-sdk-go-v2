...
func (o *BrokerTaskDataList) recurseRedact(v interface{}) {
...
func (o BrokerTaskDataList) zeroField(v interface{}) {
...
type NullableBrokerTaskDataList struct {
	value *BrokerTaskDataList
	isSet bool
}

func (v NullableBrokerTaskDataList) Get() *BrokerTaskDataList {
	return v.value
}

func (v *NullableBrokerTaskDataList) Set(val *BrokerTaskDataList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableBrokerTaskDataList(val *BrokerTaskDataList) *NullableBrokerTaskDataList {
	return &NullableBrokerTaskDataList{value: val, isSet: true}
}
