...
func NewBrokerRemovalDataListAllOf(data []BrokerRemovalData) *BrokerRemovalDataListAllOf {
	this := BrokerRemovalDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *BrokerRemovalDataListAllOf) recurseRedact(v interface{}) {
...
func (o BrokerRemovalDataListAllOf) zeroField(v interface{}) {
...
type NullableBrokerRemovalDataListAllOf struct {
	value *BrokerRemovalDataListAllOf
	isSet bool
}

func (v NullableBrokerRemovalDataListAllOf) Get() *BrokerRemovalDataListAllOf {
	return v.value
}

func (v *NullableBrokerRemovalDataListAllOf) Set(val *BrokerRemovalDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBrokerRemovalDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBrokerRemovalDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrokerRemovalDataListAllOf(val *BrokerRemovalDataListAllOf) *NullableBrokerRemovalDataListAllOf {
	return &NullableBrokerRemovalDataListAllOf{value: val, isSet: true}
}
