...
func NewAlterBrokerReplicaExclusionDataList(kind string, metadata ResourceCollectionMetadata, data []AlterBrokerReplicaExclusionData) *AlterBrokerReplicaExclusionDataList {
	this := AlterBrokerReplicaExclusionDataList{}
	this.Kind = kind
...
func (o *AlterBrokerReplicaExclusionDataList) Redact() {
	o.recurseRedact(&o.Kind)
	o.recurseRedact(&o.Metadata)
	o.recurseRedact(&o.Data)
}

func (o *AlterBrokerReplicaExclusionDataList) recurseRedact(v interface{}) {
...
func (o AlterBrokerReplicaExclusionDataList) zeroField(v interface{}) {
...
func (v NullableAlterBrokerReplicaExclusionDataList) Get() *AlterBrokerReplicaExclusionDataList {
	return v.value
}

func (v *NullableAlterBrokerReplicaExclusionDataList) Set(val *AlterBrokerReplicaExclusionDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableAlterBrokerReplicaExclusionDataList) IsSet() bool {
	return v.isSet
}

func (v *NullableAlterBrokerReplicaExclusionDataList) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableAlterBrokerReplicaExclusionDataList(val *AlterBrokerReplicaExclusionDataList) *NullableAlterBrokerReplicaExclusionDataList {
	return &NullableAlterBrokerReplicaExclusionDataList{value: val, isSet: true}
}
