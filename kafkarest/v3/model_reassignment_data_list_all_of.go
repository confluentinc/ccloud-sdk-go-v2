...
func NewReassignmentDataListAllOf(data []ReassignmentData) *ReassignmentDataListAllOf {
	this := ReassignmentDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *ReassignmentDataListAllOf) recurseRedact(v interface{}) {
...
func (o ReassignmentDataListAllOf) zeroField(v interface{}) {
...
type NullableReassignmentDataListAllOf struct {
	value *ReassignmentDataListAllOf
	isSet bool
}

func (v NullableReassignmentDataListAllOf) Get() *ReassignmentDataListAllOf {
	return v.value
}

func (v *NullableReassignmentDataListAllOf) Set(val *ReassignmentDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableReassignmentDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableReassignmentDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReassignmentDataListAllOf(val *ReassignmentDataListAllOf) *NullableReassignmentDataListAllOf {
	return &NullableReassignmentDataListAllOf{value: val, isSet: true}
}
