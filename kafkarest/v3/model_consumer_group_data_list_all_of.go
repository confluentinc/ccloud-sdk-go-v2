...
func NewConsumerGroupDataListAllOf(data []ConsumerGroupData) *ConsumerGroupDataListAllOf {
	this := ConsumerGroupDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *ConsumerGroupDataListAllOf) recurseRedact(v interface{}) {
...
func (o ConsumerGroupDataListAllOf) zeroField(v interface{}) {
...
type NullableConsumerGroupDataListAllOf struct {
	value *ConsumerGroupDataListAllOf
	isSet bool
}

func (v NullableConsumerGroupDataListAllOf) Get() *ConsumerGroupDataListAllOf {
	return v.value
}

func (v *NullableConsumerGroupDataListAllOf) Set(val *ConsumerGroupDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableConsumerGroupDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableConsumerGroupDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConsumerGroupDataListAllOf(val *ConsumerGroupDataListAllOf) *NullableConsumerGroupDataListAllOf {
	return &NullableConsumerGroupDataListAllOf{value: val, isSet: true}
}
