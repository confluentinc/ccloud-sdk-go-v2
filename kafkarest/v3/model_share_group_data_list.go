...
func (o *ShareGroupDataList) Redact() {
	o.recurseRedact(&o.Kind)
	o.recurseRedact(&o.Metadata)
	o.recurseRedact(&o.Data)
}

func (o *ShareGroupDataList) recurseRedact(v interface{}) {
...
func (o ShareGroupDataList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o ShareGroupDataList) MarshalJSON() ([]byte, error) {
...
type NullableShareGroupDataList struct {
	value *ShareGroupDataList
	isSet bool
}

func (v NullableShareGroupDataList) Get() *ShareGroupDataList {
	return v.value
}

func (v *NullableShareGroupDataList) Set(val *ShareGroupDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableShareGroupDataList) IsSet() bool {
	return v.isSet
}

func (v *NullableShareGroupDataList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareGroupDataList(val *ShareGroupDataList) *NullableShareGroupDataList {
	return &NullableShareGroupDataList{value: val, isSet: true}
}

func (v NullableShareGroupDataList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableShareGroupDataList) UnmarshalJSON(src []byte) error {
	v.isSet = true
