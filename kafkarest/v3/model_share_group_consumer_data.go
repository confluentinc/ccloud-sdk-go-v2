...
// ShareGroupConsumerData struct for ShareGroupConsumerData
...
func (o *ShareGroupConsumerData) Redact() {
...
func (o *ShareGroupConsumerData) recurseRedact(v interface{}) {
...
func (o ShareGroupConsumerData) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o ShareGroupConsumerData) MarshalJSON() ([]byte, error) {
...
type NullableShareGroupConsumerData struct {
	value *ShareGroupConsumerData
	isSet bool
}

func (v NullableShareGroupConsumerData) Get() *ShareGroupConsumerData {
	return v.value
}

func (v *NullableShareGroupConsumerData) Set(val *ShareGroupConsumerData) {
	v.value = val
	v.isSet = true
}

func (v NullableShareGroupConsumerData) IsSet() bool {
	return v.isSet
}

func (v *NullableShareGroupConsumerData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareGroupConsumerData(val *ShareGroupConsumerData) *NullableShareGroupConsumerData {
	return &NullableShareGroupConsumerData{value: val, isSet: true}
}

func (v NullableShareGroupConsumerData) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableShareGroupConsumerData) UnmarshalJSON(src []byte) error {
	v.isSet = true
