...
func (o *TopicDataList) recurseRedact(v interface{}) {
...
func (o TopicDataList) zeroField(v interface{}) {
...
func (v NullableTopicDataList) Get() *TopicDataList {
	return v.value
}
...
func NewNullableTopicDataList(val *TopicDataList) *NullableTopicDataList {
	return &NullableTopicDataList{value: val, isSet: true}
}
