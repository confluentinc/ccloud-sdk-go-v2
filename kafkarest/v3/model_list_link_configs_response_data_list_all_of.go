...
func NewListLinkConfigsResponseDataListAllOf(data []ListLinkConfigsResponseData) *ListLinkConfigsResponseDataListAllOf {
	this := ListLinkConfigsResponseDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *ListLinkConfigsResponseDataListAllOf) Redact() {
	o.recurseRedact(&o.Data)
}

func (o *ListLinkConfigsResponseDataListAllOf) recurseRedact(v interface{}) {
...
func (o ListLinkConfigsResponseDataListAllOf) zeroField(v interface{}) {
...
type NullableListLinkConfigsResponseDataListAllOf struct {
	value *ListLinkConfigsResponseDataListAllOf
	isSet bool
}

func (v NullableListLinkConfigsResponseDataListAllOf) Get() *ListLinkConfigsResponseDataListAllOf {
	return v.value
}

func (v *NullableListLinkConfigsResponseDataListAllOf) Set(val *ListLinkConfigsResponseDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableListLinkConfigsResponseDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableListLinkConfigsResponseDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableListLinkConfigsResponseDataListAllOf(val *ListLinkConfigsResponseDataListAllOf) *NullableListLinkConfigsResponseDataListAllOf {
	return &NullableListLinkConfigsResponseDataListAllOf{value: val, isSet: true}
}

func (v NullableListLinkConfigsResponseDataListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLinkConfigsResponseDataListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
