...
func NewListLinksResponseDataListAllOf(data []ListLinksResponseData) *ListLinksResponseDataListAllOf {
	this := ListLinksResponseDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *ListLinksResponseDataListAllOf) recurseRedact(v interface{}) {
...
func (o ListLinksResponseDataListAllOf) zeroField(v interface{}) {
...
type NullableListLinksResponseDataListAllOf struct {
	value *ListLinksResponseDataListAllOf
	isSet bool
}

func (v NullableListLinksResponseDataListAllOf) Get() *ListLinksResponseDataListAllOf {
	return v.value
}

func (v *NullableListLinksResponseDataListAllOf) Set(val *ListLinksResponseDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableListLinksResponseDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableListLinksResponseDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLinksResponseDataListAllOf(val *ListLinksResponseDataListAllOf) *NullableListLinksResponseDataListAllOf {
	return &NullableListLinksResponseDataListAllOf{value: val, isSet: true}
}
