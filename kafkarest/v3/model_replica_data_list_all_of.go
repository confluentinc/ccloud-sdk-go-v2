...
func (o *ReplicaDataListAllOf) recurseRedact(v interface{}) {
...
func (o ReplicaDataListAllOf) zeroField(v interface{}) {
...
type NullableReplicaDataListAllOf struct {
	value *ReplicaDataListAllOf
	isSet bool
}

func (v NullableReplicaDataListAllOf) Get() *ReplicaDataListAllOf {
	return v.value
}

func (v *NullableReplicaDataListAllOf) Set(val *ReplicaDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableReplicaDataListAllOf) IsSet() bool {
	return v.isSet
}
...
func NewNullableReplicaDataListAllOf(val *ReplicaDataListAllOf) *NullableReplicaDataListAllOf {
	return &NullableReplicaDataListAllOf{value: val, isSet: true}
}
