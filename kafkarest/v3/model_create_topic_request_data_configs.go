...
func NewCreateTopicRequestDataConfigs(name string) *CreateTopicRequestDataConfigs {
	this := CreateTopicRequestDataConfigs{}
	this.Name = name
	return &this
}
...
type NullableCreateTopicRequestDataConfigs struct {
	value *CreateTopicRequestDataConfigs
	isSet bool
}

func (v NullableCreateTopicRequestDataConfigs) Get() *CreateTopicRequestDataConfigs {
	return v.value
}

func (v *NullableCreateTopicRequestDataConfigs) Set(val *CreateTopicRequestDataConfigs) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTopicRequestDataConfigs) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTopicRequestDataConfigs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTopicRequestDataConfigs(val *CreateTopicRequestDataConfigs) *NullableCreateTopicRequestDataConfigs {
	return &NullableCreateTopicRequestDataConfigs{value: val, isSet: true}
}
