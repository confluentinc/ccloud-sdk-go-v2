...
func (o *ClusterConfigData) recurseRedact(v interface{}) {
...
func (o ClusterConfigData) zeroField(v interface{}) {
...
type NullableClusterConfigData struct {
	value *ClusterConfigData
	isSet bool
}

func (v NullableClusterConfigData) Get() *ClusterConfigData {
	return v.value
}

func (v *NullableClusterConfigData) Set(val *ClusterConfigData) {
	v.value = val
	v.isSet = true
}
...
func NewNullableClusterConfigData(val *ClusterConfigData) *NullableClusterConfigData {
	return &NullableClusterConfigData{value: val, isSet: true}
}
