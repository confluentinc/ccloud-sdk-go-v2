...
func NewCreateAclRequestDataListAllOf(data []CreateAclRequestData) *CreateAclRequestDataListAllOf {
	this := CreateAclRequestDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *CreateAclRequestDataListAllOf) recurseRedact(v interface{}) {
...
func (o CreateAclRequestDataListAllOf) zeroField(v interface{}) {
...
type NullableCreateAclRequestDataListAllOf struct {
	value *CreateAclRequestDataListAllOf
	isSet bool
}

func (v NullableCreateAclRequestDataListAllOf) Get() *CreateAclRequestDataListAllOf {
	return v.value
}

func (v *NullableCreateAclRequestDataListAllOf) Set(val *CreateAclRequestDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAclRequestDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAclRequestDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAclRequestDataListAllOf(val *CreateAclRequestDataListAllOf) *NullableCreateAclRequestDataListAllOf {
	return &NullableCreateAclRequestDataListAllOf{value: val, isSet: true}
}
