...
func (o *PartitionDataList) recurseRedact(v interface{}) {
...
func (o PartitionDataList) zeroField(v interface{}) {
...
type NullablePartitionDataList struct {
	value *PartitionDataList
	isSet bool
}

func (v NullablePartitionDataList) Get() *PartitionDataList {
	return v.value
}

func (v *NullablePartitionDataList) Set(val *PartitionDataList) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePartitionDataList(val *PartitionDataList) *NullablePartitionDataList {
	return &NullablePartitionDataList{value: val, isSet: true}
}
