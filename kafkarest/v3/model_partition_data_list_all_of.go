...
func (o *PartitionDataListAllOf) recurseRedact(v interface{}) {
...
func (o PartitionDataListAllOf) zeroField(v interface{}) {
...
type NullablePartitionDataListAllOf struct {
	value *PartitionDataListAllOf
	isSet bool
}

func (v NullablePartitionDataListAllOf) Get() *PartitionDataListAllOf {
	return v.value
}

func (v *NullablePartitionDataListAllOf) Set(val *PartitionDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePartitionDataListAllOf) IsSet() bool {
	return v.isSet
}
...
func NewNullablePartitionDataListAllOf(val *PartitionDataListAllOf) *NullablePartitionDataListAllOf {
	return &NullablePartitionDataListAllOf{value: val, isSet: true}
}
