...
type ConsumerGroupV3Api struct {
	...
	GetKafkaConsumerFunc func(ctx context.Context, clusterId, consumerGroupId, consumerId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerRequest

	lockGetKafkaConsumerExecute sync.Mutex
	GetKafkaConsumerExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerData, *net_http.Response, error)

	lockGetKafkaConsumerGroup sync.Mutex
	GetKafkaConsumerGroupFunc func(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupRequest

	lockGetKafkaConsumerGroupExecute sync.Mutex
	GetKafkaConsumerGroupExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerGroupData, *net_http.Response, error)

	lockGetKafkaConsumerGroupLagSummary sync.Mutex
	GetKafkaConsumerGroupLagSummaryFunc func(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupLagSummaryRequest

	lockGetKafkaConsumerGroupLagSummaryExecute sync.Mutex
	GetKafkaConsumerGroupLagSummaryExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupLagSummaryRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerGroupLagSummaryData, *net_http.Response, error)

	lockGetKafkaConsumerLag sync.Mutex
	GetKafkaConsumerLagFunc func(ctx context.Context, clusterId, consumerGroupId, topicName string, partitionId int32) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerLagRequest

	lockGetKafkaConsumerLagExecute sync.Mutex
	GetKafkaConsumerLagExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerLagRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerLagData, *net_http.Response, error)

	lockListKafkaConsumerGroups sync.Mutex
	ListKafkaConsumerGroupsFunc func(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerGroupsRequest

	lockListKafkaConsumerGroupsExecute sync.Mutex
	ListKafkaConsumerGroupsExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerGroupsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerGroupDataList, *net_http.Response, error)

	lockListKafkaConsumerLags sync.Mutex
	ListKafkaConsumerLagsFunc func(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerLagsRequest

	lockListKafkaConsumerLagsExecute sync.Mutex
	ListKafkaConsumerLagsExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerLagsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerLagDataList, *net_http.Response, error)

	lockListKafkaConsumers sync.Mutex
	ListKafkaConsumersFunc func(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumersRequest

	lockListKafkaConsumersExecute sync.Mutex
	ListKafkaConsumersExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumersRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerDataList, *net_http.Response, error)
	...
	calls struct {
		...
		GetKafkaConsumerExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerRequest
		}
		...
		GetKafkaConsumerGroupExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupRequest
		}
		...
		GetKafkaConsumerGroupLagSummaryExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupLagSummaryRequest
		}
		...
		GetKafkaConsumerLagExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerLagRequest
		}
		...
		ListKafkaConsumerGroupsExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerGroupsRequest
		}
		...
		ListKafkaConsumerLagsExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerLagsRequest
		}
		...
		ListKafkaConsumersExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumersRequest
		}
	}
}

// GetKafkaConsumer mocks base method by wrapping the associated func.
func (m *ConsumerGroupV3Api) GetKafkaConsumer(ctx context.Context, clusterId, consumerGroupId, consumerId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerRequest {
...
func (m *ConsumerGroupV3Api) GetKafkaConsumerExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerData, *net_http.Response, error) {
...
func (m *ConsumerGroupV3Api) GetKafkaConsumerGroup(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupRequest {
...
func (m *ConsumerGroupV3Api) GetKafkaConsumerGroupExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerGroupData, *net_http.Response, error) {
...
func (m *ConsumerGroupV3Api) GetKafkaConsumerGroupLagSummary(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupLagSummaryRequest {
...
func (m *ConsumerGroupV3Api) GetKafkaConsumerGroupLagSummaryExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerGroupLagSummaryRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerGroupLagSummaryData, *net_http.Response, error) {
...
func (m *ConsumerGroupV3Api) GetKafkaConsumerLag(ctx context.Context, clusterId, consumerGroupId, topicName string, partitionId int32) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerLagRequest {
...
func (m *ConsumerGroupV3Api) GetKafkaConsumerLagExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaConsumerLagRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerLagData, *net_http.Response, error) {
...
func (m *ConsumerGroupV3Api) ListKafkaConsumerGroups(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerGroupsRequest {
...
func (m *ConsumerGroupV3Api) ListKafkaConsumerGroupsExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerGroupsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerGroupDataList, *net_http.Response, error) {
...
func (m *ConsumerGroupV3Api) ListKafkaConsumerLags(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerLagsRequest {
...
func (m *ConsumerGroupV3Api) ListKafkaConsumerLagsExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumerLagsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerLagDataList, *net_http.Response, error) {
...
func (m *ConsumerGroupV3Api) ListKafkaConsumers(ctx context.Context, clusterId, consumerGroupId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumersRequest {
...
func (m *ConsumerGroupV3Api) ListKafkaConsumersExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaConsumersRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ConsumerDataList, *net_http.Response, error) {
