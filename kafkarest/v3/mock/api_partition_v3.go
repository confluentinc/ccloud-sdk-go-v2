...
type PartitionV3Api struct {
	...
	GetKafkaPartitionFunc func(ctx context.Context, clusterId, topicName string, partitionId int32) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaPartitionRequest

	lockGetKafkaPartitionExecute sync.Mutex
	GetKafkaPartitionExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaPartitionRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.PartitionData, *net_http.Response, error)

	lockListKafkaPartitions sync.Mutex
	ListKafkaPartitionsFunc func(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaPartitionsRequest

	lockListKafkaPartitionsExecute sync.Mutex
	ListKafkaPartitionsExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaPartitionsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.PartitionDataList, *net_http.Response, error)
	...
	calls struct {
		...
		GetKafkaPartitionExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaPartitionRequest
		}
		...
		ListKafkaPartitionsExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaPartitionsRequest
		}
	}
}

// GetKafkaPartition mocks base method by wrapping the associated func.
func (m *PartitionV3Api) GetKafkaPartition(ctx context.Context, clusterId, topicName string, partitionId int32) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaPartitionRequest {
...
func (m *PartitionV3Api) GetKafkaPartitionExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaPartitionRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.PartitionData, *net_http.Response, error) {
...
func (m *PartitionV3Api) ListKafkaPartitions(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaPartitionsRequest {
...
func (m *PartitionV3Api) ListKafkaPartitionsExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaPartitionsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.PartitionDataList, *net_http.Response, error) {
