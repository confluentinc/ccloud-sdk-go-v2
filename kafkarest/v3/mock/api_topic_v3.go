...
type TopicV3Api struct {
	...
	CreateKafkaTopicFunc func(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiCreateKafkaTopicRequest

	lockCreateKafkaTopicExecute sync.Mutex
	CreateKafkaTopicExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiCreateKafkaTopicRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicData, *net_http.Response, error)

	lockDeleteKafkaTopic sync.Mutex
	DeleteKafkaTopicFunc func(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiDeleteKafkaTopicRequest

	lockDeleteKafkaTopicExecute sync.Mutex
	DeleteKafkaTopicExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiDeleteKafkaTopicRequest) (*net_http.Response, error)

	lockGetKafkaTopic sync.Mutex
	GetKafkaTopicFunc func(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaTopicRequest

	lockGetKafkaTopicExecute sync.Mutex
	GetKafkaTopicExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaTopicRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicData, *net_http.Response, error)

	lockListKafkaTopics sync.Mutex
	ListKafkaTopicsFunc func(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaTopicsRequest

	lockListKafkaTopicsExecute sync.Mutex
	ListKafkaTopicsExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaTopicsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicDataList, *net_http.Response, error)

	lockUpdatePartitionCountKafkaTopic sync.Mutex
	UpdatePartitionCountKafkaTopicFunc func(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiUpdatePartitionCountKafkaTopicRequest

	lockUpdatePartitionCountKafkaTopicExecute sync.Mutex
	UpdatePartitionCountKafkaTopicExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiUpdatePartitionCountKafkaTopicRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicData, *net_http.Response, error)
	...
	calls struct {
		...
		CreateKafkaTopicExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiCreateKafkaTopicRequest
		}
		...
		DeleteKafkaTopicExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiDeleteKafkaTopicRequest
		}
		...
		GetKafkaTopicExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaTopicRequest
		}
		...
		ListKafkaTopicsExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaTopicsRequest
		}
		...
		UpdatePartitionCountKafkaTopicExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiUpdatePartitionCountKafkaTopicRequest
		}
	}
}

// CreateKafkaTopic mocks base method by wrapping the associated func.
func (m *TopicV3Api) CreateKafkaTopic(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiCreateKafkaTopicRequest {
...
func (m *TopicV3Api) CreateKafkaTopicExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiCreateKafkaTopicRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicData, *net_http.Response, error) {
...
func (m *TopicV3Api) DeleteKafkaTopic(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiDeleteKafkaTopicRequest {
...
func (m *TopicV3Api) DeleteKafkaTopicExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiDeleteKafkaTopicRequest) (*net_http.Response, error) {
...
func (m *TopicV3Api) GetKafkaTopic(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaTopicRequest {
...
func (m *TopicV3Api) GetKafkaTopicExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaTopicRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicData, *net_http.Response, error) {
...
func (m *TopicV3Api) ListKafkaTopics(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaTopicsRequest {
...
func (m *TopicV3Api) ListKafkaTopicsExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiListKafkaTopicsRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicDataList, *net_http.Response, error) {
...
func (m *TopicV3Api) UpdatePartitionCountKafkaTopic(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiUpdatePartitionCountKafkaTopicRequest {
...
func (m *TopicV3Api) UpdatePartitionCountKafkaTopicExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiUpdatePartitionCountKafkaTopicRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.TopicData, *net_http.Response, error) {
