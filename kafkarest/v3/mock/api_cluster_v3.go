...
type ClusterV3Api struct {
	...
	GetKafkaClusterFunc func(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaClusterRequest

	lockGetKafkaClusterExecute sync.Mutex
	GetKafkaClusterExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaClusterRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ClusterData, *net_http.Response, error)
	...
	calls struct {
		...
		GetKafkaClusterExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaClusterRequest
		}
	}
}

// GetKafkaCluster mocks base method by wrapping the associated func.
func (m *ClusterV3Api) GetKafkaCluster(ctx context.Context, clusterId string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaClusterRequest {
...
func (m *ClusterV3Api) GetKafkaClusterExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiGetKafkaClusterRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ClusterData, *net_http.Response, error) {
