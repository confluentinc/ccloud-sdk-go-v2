...
type ACLV3Api struct {
	...
	BatchCreateKafkaAclsFunc func(ctx context.Context, clusterId string) command_line_arguments.ApiBatchCreateKafkaAclsRequest

	lockBatchCreateKafkaAclsExecute sync.Mutex
	BatchCreateKafkaAclsExecuteFunc func(r command_line_arguments.ApiBatchCreateKafkaAclsRequest) (*net_http.Response, error)
	...
	calls struct {
		...
		BatchCreateKafkaAclsExecute []struct {
			R command_line_arguments.ApiBatchCreateKafkaAclsRequest
		}
...
func (m *ACLV3Api) BatchCreateKafkaAcls(ctx context.Context, clusterId string) command_line_arguments.ApiBatchCreateKafkaAclsRequest {
...
func (m *ACLV3Api) BatchCreateKafkaAclsExecute(r command_line_arguments.ApiBatchCreateKafkaAclsRequest) (*net_http.Response, error) {
