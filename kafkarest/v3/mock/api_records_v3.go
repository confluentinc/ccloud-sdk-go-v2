...
type RecordsV3Api struct {
	...
	ProduceRecordFunc func(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiProduceRecordRequest

	lockProduceRecordExecute sync.Mutex
	ProduceRecordExecuteFunc func(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiProduceRecordRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ProduceResponse, *net_http.Response, error)
	...
	calls struct {
		...
		ProduceRecordExecute []struct {
			R github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiProduceRecordRequest
		}
	}
}

// ProduceRecord mocks base method by wrapping the associated func.
func (m *RecordsV3Api) ProduceRecord(ctx context.Context, clusterId, topicName string) github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiProduceRecordRequest {
...
func (m *RecordsV3Api) ProduceRecordExecute(r github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ApiProduceRecordRequest) (github_com_confluentinc_ccloud_sdk_go_v2_kafkarest.ProduceResponse, *net_http.Response, error) {
