...
// ShareGroupConsumerAssignmentDataList struct for ShareGroupConsumerAssignmentDataList
...
func NewShareGroupConsumerAssignmentDataList(kind string, metadata ResourceCollectionMetadata, data []ShareGroupConsumerAssignmentData) *ShareGroupConsumerAssignmentDataList {
	this := ShareGroupConsumerAssignmentDataList{}
	this.Kind = kind
...
func (o *ShareGroupConsumerAssignmentDataList) Redact() {
	o.recurseRedact(&o.Kind)
	o.recurseRedact(&o.Metadata)
	o.recurseRedact(&o.Data)
}

func (o *ShareGroupConsumerAssignmentDataList) recurseRedact(v interface{}) {
...
func (o ShareGroupConsumerAssignmentDataList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o ShareGroupConsumerAssignmentDataList) MarshalJSON() ([]byte, error) {
...
type NullableShareGroupConsumerAssignmentDataList struct {
	value *ShareGroupConsumerAssignmentDataList
	isSet bool
}

func (v NullableShareGroupConsumerAssignmentDataList) Get() *ShareGroupConsumerAssignmentDataList {
	return v.value
}

func (v *NullableShareGroupConsumerAssignmentDataList) Set(val *ShareGroupConsumerAssignmentDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableShareGroupConsumerAssignmentDataList) IsSet() bool {
	return v.isSet
}

func (v *NullableShareGroupConsumerAssignmentDataList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareGroupConsumerAssignmentDataList(val *ShareGroupConsumerAssignmentDataList) *NullableShareGroupConsumerAssignmentDataList {
	return &NullableShareGroupConsumerAssignmentDataList{value: val, isSet: true}
}

func (v NullableShareGroupConsumerAssignmentDataList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableShareGroupConsumerAssignmentDataList) UnmarshalJSON(src []byte) error {
	v.isSet = true
