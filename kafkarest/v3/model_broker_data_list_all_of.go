...
func (o *BrokerDataListAllOf) recurseRedact(v interface{}) {
...
func (o BrokerDataListAllOf) zeroField(v interface{}) {
...
type NullableBrokerDataListAllOf struct {
	value *BrokerDataListAllOf
	isSet bool
}

func (v NullableBrokerDataListAllOf) Get() *BrokerDataListAllOf {
	return v.value
}

func (v *NullableBrokerDataListAllOf) Set(val *BrokerDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBrokerDataListAllOf) IsSet() bool {
	return v.isSet
}
...
func NewNullableBrokerDataListAllOf(val *BrokerDataListAllOf) *NullableBrokerDataListAllOf {
	return &NullableBrokerDataListAllOf{value: val, isSet: true}
}
