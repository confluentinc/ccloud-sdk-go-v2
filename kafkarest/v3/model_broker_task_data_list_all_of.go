...
func (o *BrokerTaskDataListAllOf) recurseRedact(v interface{}) {
...
func (o BrokerTaskDataListAllOf) zeroField(v interface{}) {
...
type NullableBrokerTaskDataListAllOf struct {
	value *BrokerTaskDataListAllOf
	isSet bool
}

func (v NullableBrokerTaskDataListAllOf) Get() *BrokerTaskDataListAllOf {
	return v.value
}

func (v *NullableBrokerTaskDataListAllOf) Set(val *BrokerTaskDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBrokerTaskDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBrokerTaskDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBrokerTaskDataListAllOf(val *BrokerTaskDataListAllOf) *NullableBrokerTaskDataListAllOf {
	return &NullableBrokerTaskDataListAllOf{value: val, isSet: true}
}
