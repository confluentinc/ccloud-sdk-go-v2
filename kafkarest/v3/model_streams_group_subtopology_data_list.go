...
// StreamsGroupSubtopologyDataList The list of Streams group subtopologies.
...
func NewStreamsGroupSubtopologyDataList(kind string, metadata ResourceCollectionMetadata, data []StreamsGroupSubtopologyData) *StreamsGroupSubtopologyDataList {
	this := StreamsGroupSubtopologyDataList{}
	this.Kind = kind
...
func (o *StreamsGroupSubtopologyDataList) Redact() {
	o.recurseRedact(&o.Kind)
	o.recurseRedact(&o.Metadata)
	o.recurseRedact(&o.Data)
}

func (o *StreamsGroupSubtopologyDataList) recurseRedact(v interface{}) {
...
func (o StreamsGroupSubtopologyDataList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o StreamsGroupSubtopologyDataList) MarshalJSON() ([]byte, error) {
...
type NullableStreamsGroupSubtopologyDataList struct {
	value *StreamsGroupSubtopologyDataList
	isSet bool
}

func (v NullableStreamsGroupSubtopologyDataList) Get() *StreamsGroupSubtopologyDataList {
	return v.value
}

func (v *NullableStreamsGroupSubtopologyDataList) Set(val *StreamsGroupSubtopologyDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamsGroupSubtopologyDataList) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamsGroupSubtopologyDataList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamsGroupSubtopologyDataList(val *StreamsGroupSubtopologyDataList) *NullableStreamsGroupSubtopologyDataList {
	return &NullableStreamsGroupSubtopologyDataList{value: val, isSet: true}
}

func (v NullableStreamsGroupSubtopologyDataList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableStreamsGroupSubtopologyDataList) UnmarshalJSON(src []byte) error {
	v.isSet = true
