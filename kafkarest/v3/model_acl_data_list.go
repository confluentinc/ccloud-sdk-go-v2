...
func (o *AclDataList) recurseRedact(v interface{}) {
...
func (o AclDataList) zeroField(v interface{}) {
...
func (v NullableAclDataList) Get() *AclDataList {
	return v.value
}
...
func NewNullableAclDataList(val *AclDataList) *NullableAclDataList {
	return &NullableAclDataList{value: val, isSet: true}
}
