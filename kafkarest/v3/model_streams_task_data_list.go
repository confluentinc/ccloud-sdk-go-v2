...
// StreamsTaskDataList The list of Streams tasks.
...
func (o *StreamsTaskDataList) Redact() {
	o.recurseRedact(&o.Kind)
	o.recurseRedact(&o.Metadata)
	o.recurseRedact(&o.Data)
}

func (o *StreamsTaskDataList) recurseRedact(v interface{}) {
...
func (o StreamsTaskDataList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o StreamsTaskDataList) MarshalJSON() ([]byte, error) {
...
type NullableStreamsTaskDataList struct {
	value *StreamsTaskDataList
	isSet bool
}

func (v NullableStreamsTaskDataList) Get() *StreamsTaskDataList {
	return v.value
}

func (v *NullableStreamsTaskDataList) Set(val *StreamsTaskDataList) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamsTaskDataList) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamsTaskDataList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamsTaskDataList(val *StreamsTaskDataList) *NullableStreamsTaskDataList {
	return &NullableStreamsTaskDataList{value: val, isSet: true}
}

func (v NullableStreamsTaskDataList) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableStreamsTaskDataList) UnmarshalJSON(src []byte) error {
	v.isSet = true
