...
func NewReplicaStatusDataListAllOf(data []ReplicaStatusData) *ReplicaStatusDataListAllOf {
	this := ReplicaStatusDataListAllOf{}
	this.Data = data
	return &this
}
...
func (o *ReplicaStatusDataListAllOf) recurseRedact(v interface{}) {
...
func (o ReplicaStatusDataListAllOf) zeroField(v interface{}) {
...
type NullableReplicaStatusDataListAllOf struct {
	value *ReplicaStatusDataListAllOf
	isSet bool
}

func (v NullableReplicaStatusDataListAllOf) Get() *ReplicaStatusDataListAllOf {
	return v.value
}

func (v *NullableReplicaStatusDataListAllOf) Set(val *ReplicaStatusDataListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableReplicaStatusDataListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableReplicaStatusDataListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReplicaStatusDataListAllOf(val *ReplicaStatusDataListAllOf) *NullableReplicaStatusDataListAllOf {
	return &NullableReplicaStatusDataListAllOf{value: val, isSet: true}
}
