...
func (o *AiV1Availability) recurseRedact(v interface{}) {
...
func (o AiV1Availability) zeroField(v interface{}) {
...
type NullableAiV1Availability struct {
	value *AiV1Availability
	isSet bool
}

func (v NullableAiV1Availability) Get() *AiV1Availability {
	return v.value
}

func (v *NullableAiV1Availability) Set(val *AiV1Availability) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAiV1Availability(val *AiV1Availability) *NullableAiV1Availability {
	return &NullableAiV1Availability{value: val, isSet: true}
}
