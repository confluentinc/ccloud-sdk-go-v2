...
func main() {
    ...
    inlineObject := *openapiclient.NewInlineObject("AWS", "us-east-1", "env-00000", "DisplayName_example", openapiclient.InlineObjectUploadSourceOneOf{ArtifactV1UploadSourcePresignedUrl: openapiclient.NewArtifactV1UploadSourcePresignedUrl()}) // InlineObject |  (optional)
