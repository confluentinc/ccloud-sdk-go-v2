...
func NewCdxV1ProviderSharedResourceList(apiVersion string, kind string, metadata ListMeta, data []CdxV1ProviderSharedResource) *CdxV1ProviderSharedResourceList {
	this := CdxV1ProviderSharedResourceList{}
...
func (o *CdxV1ProviderSharedResourceList) GetData() []CdxV1ProviderSharedResource {
	if o == nil {
		var ret []CdxV1ProviderSharedResource
		return ret
	}
...
func (o *CdxV1ProviderSharedResourceList) recurseRedact(v interface{}) {
...
func (o CdxV1ProviderSharedResourceList) zeroField(v interface{}) {
...
type NullableCdxV1ProviderSharedResourceList struct {
	value *CdxV1ProviderSharedResourceList
	isSet bool
}

func (v NullableCdxV1ProviderSharedResourceList) Get() *CdxV1ProviderSharedResourceList {
	return v.value
}

func (v *NullableCdxV1ProviderSharedResourceList) Set(val *CdxV1ProviderSharedResourceList) {
	v.value = val
	v.isSet = true
}

func (v NullableCdxV1ProviderSharedResourceList) IsSet() bool {
	return v.isSet
}

func (v *NullableCdxV1ProviderSharedResourceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdxV1ProviderSharedResourceList(val *CdxV1ProviderSharedResourceList) *NullableCdxV1ProviderSharedResourceList {
	return &NullableCdxV1ProviderSharedResourceList{value: val, isSet: true}
}
