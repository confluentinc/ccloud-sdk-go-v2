...
type apiListConnectv1ConnectorPluginsRequest struct {
	...
	apiService     *PluginsV1ApiService
...
func (r apiListConnectv1ConnectorPluginsRequest) Execute() ([]InlineResponse2002, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "PluginsV1ApiService.ListConnectv1ConnectorPlugins")
	if err != nil {
...
func (r apiValidateConnectv1ConnectorPluginRequest) Execute() (InlineResponse2003, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "PluginsV1ApiService.ValidateConnectv1ConnectorPlugin")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarPath = strings.Replace(localVarPath, "{"+"plugin_name"+"}", _neturl.QueryEscape(parameterToString(r.pluginName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environment_id"+"}", _neturl.QueryEscape(parameterToString(r.environmentId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"kafka_cluster_id"+"}", _neturl.QueryEscape(parameterToString(r.kafkaClusterId, "")), -1)
