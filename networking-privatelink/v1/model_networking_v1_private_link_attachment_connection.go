...
func NewNetworkingV1PrivateLinkAttachmentConnection() *NetworkingV1PrivateLinkAttachmentConnection {
	this := NetworkingV1PrivateLinkAttachmentConnection{}
	return &this
}
...
func (o *NetworkingV1PrivateLinkAttachmentConnection) GetSpec() NetworkingV1PrivateLinkAttachmentConnectionSpec {
	if o == nil || o.Spec == nil {
		var ret NetworkingV1PrivateLinkAttachmentConnectionSpec
		return ret
	}
	return *o.Spec
}
...
func (o *NetworkingV1PrivateLinkAttachmentConnection) Redact() {
...
func (o *NetworkingV1PrivateLinkAttachmentConnection) recurseRedact(v interface{}) {
...
func (o NetworkingV1PrivateLinkAttachmentConnection) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingV1PrivateLinkAttachmentConnection) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingV1PrivateLinkAttachmentConnection struct {
	value *NetworkingV1PrivateLinkAttachmentConnection
	isSet bool
}

func (v NullableNetworkingV1PrivateLinkAttachmentConnection) Get() *NetworkingV1PrivateLinkAttachmentConnection {
	return v.value
}

func (v *NullableNetworkingV1PrivateLinkAttachmentConnection) Set(val *NetworkingV1PrivateLinkAttachmentConnection) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PrivateLinkAttachmentConnection) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PrivateLinkAttachmentConnection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PrivateLinkAttachmentConnection(val *NetworkingV1PrivateLinkAttachmentConnection) *NullableNetworkingV1PrivateLinkAttachmentConnection {
	return &NullableNetworkingV1PrivateLinkAttachmentConnection{value: val, isSet: true}
}
