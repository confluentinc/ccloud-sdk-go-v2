...
func NewNetworkingV1AzurePrivateLinkAttachmentConnection(kind string, privateEndpointResourceId string) *NetworkingV1AzurePrivateLinkAttachmentConnection {
	this := NetworkingV1AzurePrivateLinkAttachmentConnection{}
	this.Kind = kind
...
func (o *NetworkingV1AzurePrivateLinkAttachmentConnection) Redact() {
	o.recurseRedact(&o.Kind)
	o.recurseRedact(&o.PrivateEndpointResourceId)
}

func (o *NetworkingV1AzurePrivateLinkAttachmentConnection) recurseRedact(v interface{}) {
...
func (o NetworkingV1AzurePrivateLinkAttachmentConnection) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingV1AzurePrivateLinkAttachmentConnection) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingV1AzurePrivateLinkAttachmentConnection struct {
	value *NetworkingV1AzurePrivateLinkAttachmentConnection
	isSet bool
}

func (v NullableNetworkingV1AzurePrivateLinkAttachmentConnection) Get() *NetworkingV1AzurePrivateLinkAttachmentConnection {
	return v.value
}

func (v *NullableNetworkingV1AzurePrivateLinkAttachmentConnection) Set(val *NetworkingV1AzurePrivateLinkAttachmentConnection) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1AzurePrivateLinkAttachmentConnection) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1AzurePrivateLinkAttachmentConnection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1AzurePrivateLinkAttachmentConnection(val *NetworkingV1AzurePrivateLinkAttachmentConnection) *NullableNetworkingV1AzurePrivateLinkAttachmentConnection {
	return &NullableNetworkingV1AzurePrivateLinkAttachmentConnection{value: val, isSet: true}
}
