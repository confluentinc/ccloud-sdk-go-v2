...
func NewNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate() *NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate {
	this := NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate{}
	return &this
}
...
func (o *NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) Redact() {
	o.recurseRedact(o.DisplayName)
	o.recurseRedact(o.Environment)
}

func (o *NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) recurseRedact(v interface{}) {
...
func (o NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) MarshalJSON() ([]byte, error) {
...
type NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate struct {
	value *NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate
	isSet bool
}

func (v NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) Get() *NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate {
	return v.value
}

func (v *NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) Set(val *NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate(val *NetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) *NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate {
	return &NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate{value: val, isSet: true}
}

func (v NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PrivateLinkAttachmentConnectionSpecUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
