...
type KsqldbcmV1ClusterList struct {
	...
	Data []KsqldbcmV1Cluster `json:"data"`
}
...
func (o *KsqldbcmV1ClusterList) Redact() {
...
func (o *KsqldbcmV1ClusterList) recurseRedact(v interface{}) {
...
func (o KsqldbcmV1ClusterList) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o KsqldbcmV1ClusterList) MarshalJSON() ([]byte, error) {
...
type NullableKsqldbcmV1ClusterList struct {
	value *KsqldbcmV1ClusterList
	isSet bool
}

func (v NullableKsqldbcmV1ClusterList) Get() *KsqldbcmV1ClusterList {
	return v.value
}

func (v *NullableKsqldbcmV1ClusterList) Set(val *KsqldbcmV1ClusterList) {
	v.value = val
	v.isSet = true
}

func (v NullableKsqldbcmV1ClusterList) IsSet() bool {
	return v.isSet
}

func (v *NullableKsqldbcmV1ClusterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKsqldbcmV1ClusterList(val *KsqldbcmV1ClusterList) *NullableKsqldbcmV1ClusterList {
	return &NullableKsqldbcmV1ClusterList{value: val, isSet: true}
}

func (v NullableKsqldbcmV1ClusterList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKsqldbcmV1ClusterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
