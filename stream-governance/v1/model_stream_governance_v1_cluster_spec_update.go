...
// StreamGovernanceV1ClusterSpecUpdate The desired state of the Cluster
type StreamGovernanceV1ClusterSpecUpdate struct {
	// The billing package.
...
func NewStreamGovernanceV1ClusterSpecUpdate() *StreamGovernanceV1ClusterSpecUpdate {
	this := StreamGovernanceV1ClusterSpecUpdate{}
	return &this
}
...
func (o *StreamGovernanceV1ClusterSpecUpdate) Redact() {
    o.recurseRedact(o.Package)
    o.recurseRedact(o.Environment)
}

func (o *StreamGovernanceV1ClusterSpecUpdate) recurseRedact(v interface{}) {
...
func (o StreamGovernanceV1ClusterSpecUpdate) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o StreamGovernanceV1ClusterSpecUpdate) MarshalJSON() ([]byte, error) {
...
type NullableStreamGovernanceV1ClusterSpecUpdate struct {
	value *StreamGovernanceV1ClusterSpecUpdate
	isSet bool
}

func (v NullableStreamGovernanceV1ClusterSpecUpdate) Get() *StreamGovernanceV1ClusterSpecUpdate {
	return v.value
}

func (v *NullableStreamGovernanceV1ClusterSpecUpdate) Set(val *StreamGovernanceV1ClusterSpecUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamGovernanceV1ClusterSpecUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamGovernanceV1ClusterSpecUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamGovernanceV1ClusterSpecUpdate(val *StreamGovernanceV1ClusterSpecUpdate) *NullableStreamGovernanceV1ClusterSpecUpdate {
	return &NullableStreamGovernanceV1ClusterSpecUpdate{value: val, isSet: true}
}

func (v NullableStreamGovernanceV1ClusterSpecUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamGovernanceV1ClusterSpecUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
