...
type StreamGovernanceV1Cluster struct {
	...
	Spec *StreamGovernanceV1ClusterSpec `json:"spec,omitempty"`
...
func NewStreamGovernanceV1Cluster() *StreamGovernanceV1Cluster {
	this := StreamGovernanceV1Cluster{}
	return &this
}
...
func (o *StreamGovernanceV1Cluster) GetSpec() StreamGovernanceV1ClusterSpec {
	if o == nil || o.Spec == nil {
		var ret StreamGovernanceV1ClusterSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given StreamGovernanceV1ClusterSpec and assigns it to the Spec field.
...
func (o *StreamGovernanceV1Cluster) Redact() {
...
func (o *StreamGovernanceV1Cluster) recurseRedact(v interface{}) {
...
func (o StreamGovernanceV1Cluster) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o StreamGovernanceV1Cluster) MarshalJSON() ([]byte, error) {
...
type NullableStreamGovernanceV1Cluster struct {
	value *StreamGovernanceV1Cluster
	isSet bool
}

func (v NullableStreamGovernanceV1Cluster) Get() *StreamGovernanceV1Cluster {
	return v.value
}

func (v *NullableStreamGovernanceV1Cluster) Set(val *StreamGovernanceV1Cluster) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamGovernanceV1Cluster) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamGovernanceV1Cluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamGovernanceV1Cluster(val *StreamGovernanceV1Cluster) *NullableStreamGovernanceV1Cluster {
	return &NullableStreamGovernanceV1Cluster{value: val, isSet: true}
}

func (v NullableStreamGovernanceV1Cluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamGovernanceV1Cluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
