...
type StreamGovernanceV2RegionList struct {
	...
	Data []StreamGovernanceV2Region `json:"data"`
}
...
func NewStreamGovernanceV2RegionList(apiVersion string, kind string, metadata ListMeta, data []StreamGovernanceV2Region) *StreamGovernanceV2RegionList {
	this := StreamGovernanceV2RegionList{}
...
func (o *StreamGovernanceV2RegionList) GetData() []StreamGovernanceV2Region {
	if o == nil {
		var ret []StreamGovernanceV2Region
		return ret
	}
...
func (o *StreamGovernanceV2RegionList) Redact() {
...
func (o *StreamGovernanceV2RegionList) recurseRedact(v interface{}) {
...
func (o StreamGovernanceV2RegionList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o StreamGovernanceV2RegionList) MarshalJSON() ([]byte, error) {
...
type NullableStreamGovernanceV2RegionList struct {
	value *StreamGovernanceV2RegionList
	isSet bool
}

func (v NullableStreamGovernanceV2RegionList) Get() *StreamGovernanceV2RegionList {
	return v.value
}

func (v *NullableStreamGovernanceV2RegionList) Set(val *StreamGovernanceV2RegionList) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamGovernanceV2RegionList) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamGovernanceV2RegionList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamGovernanceV2RegionList(val *StreamGovernanceV2RegionList) *NullableStreamGovernanceV2RegionList {
	return &NullableStreamGovernanceV2RegionList{value: val, isSet: true}
}

func (v NullableStreamGovernanceV2RegionList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamGovernanceV2RegionList) UnmarshalJSON(src []byte) error {
	v.isSet = true
