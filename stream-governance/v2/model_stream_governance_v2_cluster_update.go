...
type StreamGovernanceV2ClusterUpdate struct {
	...
	Spec *StreamGovernanceV2ClusterSpecUpdate `json:"spec,omitempty"`
...
func NewStreamGovernanceV2ClusterUpdate() *StreamGovernanceV2ClusterUpdate {
	this := StreamGovernanceV2ClusterUpdate{}
	return &this
}
...
func (o *StreamGovernanceV2ClusterUpdate) GetSpec() StreamGovernanceV2ClusterSpecUpdate {
	if o == nil || o.Spec == nil {
		var ret StreamGovernanceV2ClusterSpecUpdate
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given StreamGovernanceV2ClusterSpecUpdate and assigns it to the Spec field.
...
func (o *StreamGovernanceV2ClusterUpdate) Redact() {
...
func (o *StreamGovernanceV2ClusterUpdate) recurseRedact(v interface{}) {
...
func (o StreamGovernanceV2ClusterUpdate) zeroField(v interface{}) {
    p := reflect.ValueOf(v).Elem()
    p.Set(reflect.Zero(p.Type()))
}

func (o StreamGovernanceV2ClusterUpdate) MarshalJSON() ([]byte, error) {
...
type NullableStreamGovernanceV2ClusterUpdate struct {
	value *StreamGovernanceV2ClusterUpdate
	isSet bool
}

func (v NullableStreamGovernanceV2ClusterUpdate) Get() *StreamGovernanceV2ClusterUpdate {
	return v.value
}

func (v *NullableStreamGovernanceV2ClusterUpdate) Set(val *StreamGovernanceV2ClusterUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamGovernanceV2ClusterUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamGovernanceV2ClusterUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamGovernanceV2ClusterUpdate(val *StreamGovernanceV2ClusterUpdate) *NullableStreamGovernanceV2ClusterUpdate {
	return &NullableStreamGovernanceV2ClusterUpdate{value: val, isSet: true}
}

func (v NullableStreamGovernanceV2ClusterUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamGovernanceV2ClusterUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
