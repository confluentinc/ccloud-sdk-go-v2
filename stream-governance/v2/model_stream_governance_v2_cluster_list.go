...
type StreamGovernanceV2ClusterList struct {
	...
	Data []StreamGovernanceV2Cluster `json:"data"`
}
...
func NewStreamGovernanceV2ClusterList(apiVersion string, kind string, metadata ListMeta, data []StreamGovernanceV2Cluster) *StreamGovernanceV2ClusterList {
	this := StreamGovernanceV2ClusterList{}
...
func (o *StreamGovernanceV2ClusterList) GetData() []StreamGovernanceV2Cluster {
	if o == nil {
		var ret []StreamGovernanceV2Cluster
		return ret
	}
...
func (o *StreamGovernanceV2ClusterList) Redact() {
...
func (o *StreamGovernanceV2ClusterList) recurseRedact(v interface{}) {
...
func (o StreamGovernanceV2ClusterList) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o StreamGovernanceV2ClusterList) MarshalJSON() ([]byte, error) {
...
type NullableStreamGovernanceV2ClusterList struct {
	value *StreamGovernanceV2ClusterList
	isSet bool
}

func (v NullableStreamGovernanceV2ClusterList) Get() *StreamGovernanceV2ClusterList {
	return v.value
}

func (v *NullableStreamGovernanceV2ClusterList) Set(val *StreamGovernanceV2ClusterList) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamGovernanceV2ClusterList) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamGovernanceV2ClusterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamGovernanceV2ClusterList(val *StreamGovernanceV2ClusterList) *NullableStreamGovernanceV2ClusterList {
	return &NullableStreamGovernanceV2ClusterList{value: val, isSet: true}
}

func (v NullableStreamGovernanceV2ClusterList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamGovernanceV2ClusterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
