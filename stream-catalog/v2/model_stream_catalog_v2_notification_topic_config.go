...
// StreamCatalogV2NotificationTopicConfig `Catalog Notifications Config` manages configurations for Data Catalog event notifications on Confluent Cloud. The API allows you to create (enable), read, and delete (disable) catalog notifications topic.   ## The Notification Topic Configs Model <SchemaDefinition schemaRef=\"#/components/schemas/stream-catalog.v2.NotificationTopicConfig\" />
type StreamCatalogV2NotificationTopicConfig struct {
	...
	Spec     *StreamCatalogV2NotificationTopicConfigSpec `json:"spec,omitempty"`
}
...
func NewStreamCatalogV2NotificationTopicConfig() *StreamCatalogV2NotificationTopicConfig {
	this := StreamCatalogV2NotificationTopicConfig{}
	return &this
}
...
func (o *StreamCatalogV2NotificationTopicConfig) GetSpec() StreamCatalogV2NotificationTopicConfigSpec {
	if o == nil || o.Spec == nil {
		var ret StreamCatalogV2NotificationTopicConfigSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given StreamCatalogV2NotificationTopicConfigSpec and assigns it to the Spec field.
func (o *StreamCatalogV2NotificationTopicConfig) SetSpec(v StreamCatalogV2NotificationTopicConfigSpec) {
	o.Spec = &v
}

// Redact resets all sensitive fields to their zero value.
func (o *StreamCatalogV2NotificationTopicConfig) Redact() {
...
func (o *StreamCatalogV2NotificationTopicConfig) recurseRedact(v interface{}) {
...
func (o StreamCatalogV2NotificationTopicConfig) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o StreamCatalogV2NotificationTopicConfig) MarshalJSON() ([]byte, error) {
...
type NullableStreamCatalogV2NotificationTopicConfig struct {
	value *StreamCatalogV2NotificationTopicConfig
	isSet bool
}

func (v NullableStreamCatalogV2NotificationTopicConfig) Get() *StreamCatalogV2NotificationTopicConfig {
	return v.value
}

func (v *NullableStreamCatalogV2NotificationTopicConfig) Set(val *StreamCatalogV2NotificationTopicConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamCatalogV2NotificationTopicConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamCatalogV2NotificationTopicConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamCatalogV2NotificationTopicConfig(val *StreamCatalogV2NotificationTopicConfig) *NullableStreamCatalogV2NotificationTopicConfig {
	return &NullableStreamCatalogV2NotificationTopicConfig{value: val, isSet: true}
}

func (v NullableStreamCatalogV2NotificationTopicConfig) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableStreamCatalogV2NotificationTopicConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
