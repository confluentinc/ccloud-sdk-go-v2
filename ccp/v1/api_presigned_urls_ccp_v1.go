...
type PresignedUrlsCcpV1Api interface {
	...
	/*
		...
		Request a presigned upload url to upload custom plugin archive.
			 ...
			 @return ApiPresignedUploadUrlCcpV1PresignedUrlRequest
	*/
	PresignedUploadUrlCcpV1PresignedUrl(ctx _context.Context) ApiPresignedUploadUrlCcpV1PresignedUrlRequest

	// PresignedUploadUrlCcpV1PresignedUrlExecute executes the request
	//  @return CcpV1PresignedUrl
	PresignedUploadUrlCcpV1PresignedUrlExecute(r ApiPresignedUploadUrlCcpV1PresignedUrlRequest) (CcpV1PresignedUrl, *_nethttp.Response, error)
}

// PresignedUrlsCcpV1ApiService PresignedUrlsCcpV1Api service
type PresignedUrlsCcpV1ApiService service

type ApiPresignedUploadUrlCcpV1PresignedUrlRequest struct {
	ctx                      _context.Context
	ApiService               PresignedUrlsCcpV1Api
	ccpV1PresignedUrlRequest *CcpV1PresignedUrlRequest
}
...
func (r ApiPresignedUploadUrlCcpV1PresignedUrlRequest) CcpV1PresignedUrlRequest(ccpV1PresignedUrlRequest CcpV1PresignedUrlRequest) ApiPresignedUploadUrlCcpV1PresignedUrlRequest {
	r.ccpV1PresignedUrlRequest = &ccpV1PresignedUrlRequest
	return r
}

func (r ApiPresignedUploadUrlCcpV1PresignedUrlRequest) Execute() (CcpV1PresignedUrl, *_nethttp.Response, error) {
	return r.ApiService.PresignedUploadUrlCcpV1PresignedUrlExecute(r)
}
...
func (a *PresignedUrlsCcpV1ApiService) PresignedUploadUrlCcpV1PresignedUrlExecute(r ApiPresignedUploadUrlCcpV1PresignedUrlRequest) (CcpV1PresignedUrl, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  CcpV1PresignedUrl
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PresignedUrlsCcpV1ApiService.PresignedUploadUrlCcpV1PresignedUrl")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ccp/v1/presigned-upload-url"
	...
	// body params
	localVarPostBody = r.ccpV1PresignedUrlRequest
