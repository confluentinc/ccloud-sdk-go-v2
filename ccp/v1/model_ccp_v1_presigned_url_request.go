...
type CcpV1PresignedUrlRequest struct {
...
func (o *CcpV1PresignedUrlRequest) recurseRedact(v interface{}) {
...
func (o CcpV1PresignedUrlRequest) zeroField(v interface{}) {
...
type NullableCcpV1PresignedUrlRequest struct {
	value *CcpV1PresignedUrlRequest
	isSet bool
}
...
func NewNullableCcpV1PresignedUrlRequest(val *CcpV1PresignedUrlRequest) *NullableCcpV1PresignedUrlRequest {
	return &NullableCcpV1PresignedUrlRequest{value: val, isSet: true}
}
