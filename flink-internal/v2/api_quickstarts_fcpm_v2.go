...
Return the created compute pools.
	...
	*/
	...
	// CreateFcpmV2QuickstartExecute executes the request
	//  @return FcpmV2Quickstart
	CreateFcpmV2QuickstartExecute(r ApiCreateFcpmV2QuickstartRequest) (FcpmV2Quickstart, *_nethttp.Response, error)
}

// QuickstartsFcpmV2ApiService QuickstartsFcpmV2Api service
...
func (r ApiCreateFcpmV2QuickstartRequest) FcpmV2Quickstart(fcpmV2Quickstart FcpmV2Quickstart) ApiCreateFcpmV2QuickstartRequest {
	r.fcpmV2Quickstart = &fcpmV2Quickstart
	return r
}

func (r ApiCreateFcpmV2QuickstartRequest) Execute() (FcpmV2Quickstart, *_nethttp.Response, error) {
	return r.ApiService.CreateFcpmV2QuickstartExecute(r)
}
...
func (a *QuickstartsFcpmV2ApiService) CreateFcpmV2QuickstartExecute(r ApiCreateFcpmV2QuickstartRequest) (FcpmV2Quickstart, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  FcpmV2Quickstart
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuickstartsFcpmV2ApiService.CreateFcpmV2Quickstart")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fcpm/v2/quickstart"
	...
	// body params
	localVarPostBody = r.fcpmV2Quickstart
