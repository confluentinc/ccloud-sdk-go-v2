...
func (r apiCreateV2EnvironmentRequest) Execute() (V2Environment, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentsV2ApiService.CreateV2Environment")
	if err != nil {
...
func (r apiDeleteV2EnvironmentRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentsV2ApiService.DeleteV2Environment")
	if err != nil {
...
func (r apiGetV2EnvironmentRequest) Execute() (V2Environment, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentsV2ApiService.GetV2Environment")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiListV2EnvironmentsRequest) Execute() (V2EnvironmentList, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentsV2ApiService.ListV2Environments")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateV2EnvironmentRequest) Execute() (V2Environment, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EnvironmentsV2ApiService.UpdateV2Environment")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
