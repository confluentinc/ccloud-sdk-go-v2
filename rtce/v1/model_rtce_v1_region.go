...
// RtceV1Region `Region` objects represent cloud provider regions where RtceTopics can be deployed. This API allows you to list all supported RTCE regions.   ## The Regions Model <SchemaDefinition schemaRef=\"#/components/schemas/rtce.v1.Region\" />
type RtceV1Region struct {
	...
	// The human-readable display name for the region.
...
func (o *RtceV1Region) recurseRedact(v interface{}) {
...
func (o RtceV1Region) zeroField(v interface{}) {
	p := reflect.ValueOf(v).Elem()
	p.Set(reflect.Zero(p.Type()))
}

func (o RtceV1Region) MarshalJSON() ([]byte, error) {
...
type NullableRtceV1Region struct {
	value *RtceV1Region
	isSet bool
}

func (v NullableRtceV1Region) Get() *RtceV1Region {
	return v.value
}

func (v *NullableRtceV1Region) Set(val *RtceV1Region) {
	v.value = val
	v.isSet = true
}

func (v NullableRtceV1Region) IsSet() bool {
	return v.isSet
}

func (v *NullableRtceV1Region) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRtceV1Region(val *RtceV1Region) *NullableRtceV1Region {
	return &NullableRtceV1Region{value: val, isSet: true}
}

func (v NullableRtceV1Region) MarshalJSON() ([]byte, error) {
	buffer := &bytes.Buffer{}
	encoder := json.NewEncoder(buffer)
	encoder.SetEscapeHTML(false)
...
func (v *NullableRtceV1Region) UnmarshalJSON(src []byte) error {
	v.isSet = true
