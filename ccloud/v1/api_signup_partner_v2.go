...
// SignupPartnerV2ApiService SignupPartnerV2Api service
type SignupPartnerV2ApiService service

type apiActivateSignupRequest struct {
	ctx _context.Context
	apiService *SignupPartnerV2ApiService
	activatePartnerSignupRequest *ActivatePartnerSignupRequest
}


func (r apiActivateSignupRequest) ActivatePartnerSignupRequest(activatePartnerSignupRequest ActivatePartnerSignupRequest) apiActivateSignupRequest {
	r.activatePartnerSignupRequest = &activatePartnerSignupRequest
	return r
}
...
@return apiActivateSignupRequest
*/
func (a *SignupPartnerV2ApiService) ActivateSignup(ctx _context.Context) apiActivateSignupRequest {
	return apiActivateSignupRequest{
		apiService: a,
		ctx: ctx,
	}
...
*/
func (r apiActivateSignupRequest) Execute() (PartnerSignupResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  PartnerSignupResponse
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "SignupPartnerV2ApiService.ActivateSignup")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v2/signup/activate"
	...
	// body params
	localVarPostBody = r.activatePartnerSignupRequest
...
type apiSignupRequest struct {
	ctx _context.Context
	apiService *SignupPartnerV2ApiService
	partnerSignupRequest *PartnerSignupRequest
}


func (r apiSignupRequest) PartnerSignupRequest(partnerSignupRequest PartnerSignupRequest) apiSignupRequest {
	r.partnerSignupRequest = &partnerSignupRequest
	return r
}
...
*/
func (a *SignupPartnerV2ApiService) Signup(ctx _context.Context) apiSignupRequest {
	return apiSignupRequest{
		apiService: a,
		ctx: ctx,
	}
...
Execute executes the request
 @return PartnerSignupResponse
*/
func (r apiSignupRequest) Execute() (PartnerSignupResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "SignupPartnerV2ApiService.Signup")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v2/signup"
	...
	// body params
	localVarPostBody = r.partnerSignupRequest
	req, err := r.apiService.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
