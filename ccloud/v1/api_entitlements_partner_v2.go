...
// EntitlementsPartnerV2ApiService EntitlementsPartnerV2Api service
type EntitlementsPartnerV2ApiService service

type apiCreatePartnerV2EntitlementRequest struct {
	ctx _context.Context
	apiService *EntitlementsPartnerV2ApiService
	partnerV2Entitlement *PartnerV2Entitlement
}


func (r apiCreatePartnerV2EntitlementRequest) PartnerV2Entitlement(partnerV2Entitlement PartnerV2Entitlement) apiCreatePartnerV2EntitlementRequest {
	r.partnerV2Entitlement = &partnerV2Entitlement
	return r
}
...
@return apiCreatePartnerV2EntitlementRequest
*/
func (a *EntitlementsPartnerV2ApiService) CreatePartnerV2Entitlement(ctx _context.Context) apiCreatePartnerV2EntitlementRequest {
	return apiCreatePartnerV2EntitlementRequest{
		apiService: a,
		ctx: ctx,
	}
...
Execute executes the request
 @return PartnerV2Entitlement
*/
func (r apiCreatePartnerV2EntitlementRequest) Execute() (PartnerV2Entitlement, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  PartnerV2Entitlement
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsPartnerV2ApiService.CreatePartnerV2Entitlement")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v2/entitlements"
	...
	// body params
	localVarPostBody = r.partnerV2Entitlement
...
type apiGetPartnerV2EntitlementRequest struct {
	ctx _context.Context
	apiService *EntitlementsPartnerV2ApiService
	id string
...
func (r apiGetPartnerV2EntitlementRequest) OrganizationId(organizationId string) apiGetPartnerV2EntitlementRequest {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The unique identifier for the entitlement.
@return apiGetPartnerV2EntitlementRequest
*/
func (a *EntitlementsPartnerV2ApiService) GetPartnerV2Entitlement(ctx _context.Context, id string) apiGetPartnerV2EntitlementRequest {
	return apiGetPartnerV2EntitlementRequest{
		apiService: a,
		ctx: ctx,
		id: id,
...
Execute executes the request
 @return PartnerV2Entitlement
*/
func (r apiGetPartnerV2EntitlementRequest) Execute() (PartnerV2Entitlement, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsPartnerV2ApiService.GetPartnerV2Entitlement")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v2/entitlements/{id}"
	...
	if r.organizationId != nil {
		localVarQueryParams.Add("organization.id", parameterToString(*r.organizationId, ""))
	}
	// to determine the Content-Type header
...
type apiListPartnerV2EntitlementsRequest struct {
	ctx _context.Context
	apiService *EntitlementsPartnerV2ApiService
	organizationId *string
	pageSize *int32
...
func (r apiListPartnerV2EntitlementsRequest) OrganizationId(organizationId string) apiListPartnerV2EntitlementsRequest {
	r.organizationId = &organizationId
	return r
}

func (r apiListPartnerV2EntitlementsRequest) PageSize(pageSize int32) apiListPartnerV2EntitlementsRequest {
	r.pageSize = &pageSize
	return r
}

func (r apiListPartnerV2EntitlementsRequest) PageToken(pageToken string) apiListPartnerV2EntitlementsRequest {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return apiListPartnerV2EntitlementsRequest
*/
func (a *EntitlementsPartnerV2ApiService) ListPartnerV2Entitlements(ctx _context.Context) apiListPartnerV2EntitlementsRequest {
	return apiListPartnerV2EntitlementsRequest{
		apiService: a,
		ctx: ctx,
	}
...
/*
Execute executes the request
 @return PartnerV2EntitlementList
*/
func (r apiListPartnerV2EntitlementsRequest) Execute() (PartnerV2EntitlementList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PartnerV2EntitlementList
	)

	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsPartnerV2ApiService.ListPartnerV2Entitlements")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v PartnerV2EntitlementList
			err = r.apiService.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
