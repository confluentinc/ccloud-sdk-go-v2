...
func (r apiDeleteV2UserRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "UsersV2ApiService.DeleteV2User")
	if err != nil {
...
func (r apiGetV2UserRequest) Execute() (V2User, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "UsersV2ApiService.GetV2User")
	if err != nil {
...
func (r apiListV2UsersRequest) Execute() (V2UserList, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "UsersV2ApiService.ListV2Users")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateV2UserRequest) V2User(v2User V2User) apiUpdateV2UserRequest {
	r.v2User = &v2User
	return r
}
...
func (r apiUpdateV2UserRequest) Execute() (V2User, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "UsersV2ApiService.UpdateV2User")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
