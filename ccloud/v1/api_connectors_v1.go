...
type apiCreateConnectv1ConnectorRequest struct {
	...
	apiService *ConnectorsV1ApiService
...
func (r apiCreateConnectv1ConnectorRequest) Execute() (ConnectV1Connector, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ConnectorsV1ApiService.CreateConnectv1Connector")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/connect/v1/environments/{environment_id}/clusters/{kafka_cluster_id}/connectors"
	localVarPath = strings.Replace(localVarPath, "{"+"environment_id"+"}", _neturl.QueryEscape(parameterToString(r.environmentId, "")) , -1)
	localVarPath = strings.Replace(localVarPath, "{"+"kafka_cluster_id"+"}", _neturl.QueryEscape(parameterToString(r.kafkaClusterId, "")) , -1)
...
func (r apiCreateOrUpdateConnectv1ConnectorConfigRequest) Execute() (ConnectV1Connector, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ConnectorsV1ApiService.CreateOrUpdateConnectv1ConnectorConfig")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarPath = strings.Replace(localVarPath, "{"+"connector_name"+"}", _neturl.QueryEscape(parameterToString(r.connectorName, "")) , -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environment_id"+"}", _neturl.QueryEscape(parameterToString(r.environmentId, "")) , -1)
	localVarPath = strings.Replace(localVarPath, "{"+"kafka_cluster_id"+"}", _neturl.QueryEscape(parameterToString(r.kafkaClusterId, "")) , -1)
...
func (r apiDeleteConnectv1ConnectorRequest) Execute() (InlineResponse200, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ConnectorsV1ApiService.DeleteConnectv1Connector")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetConnectv1ConnectorConfigRequest) Execute() (map[string]string, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ConnectorsV1ApiService.GetConnectv1ConnectorConfig")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiListConnectv1ConnectorsRequest) Execute() ([]string, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ConnectorsV1ApiService.ListConnectv1Connectors")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiReadConnectv1ConnectorRequest) Execute() (ConnectV1Connector, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "ConnectorsV1ApiService.ReadConnectv1Connector")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
